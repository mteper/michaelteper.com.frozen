...
<script type="text/javascript">
 ...
 var postTitle = "ICallbackEventHandler changes again";
 var postURL = "http://www.michaelteper.com:443/archive/2005/08/22/2876.aspx";
...
<script type="text/javascript" src="http://www.cocomment.com/js/cocomment.js">
	...
	<body>
		<form name="Form1" method="post" action="2876.aspx" id="Form1">
...
posts - 105, comments - 55, trackbacks - 1</div>
	<div id="switcher">
	    <a id="switchlink" href="2876.aspx#" title="Click here to change the content width" style="display:none;"><span></span></a>
	</div>
</div>
...
<div class="previousNext">
	<a id="ctl06_PreviousNext_PrevLink" title="previous post" href="../../07/13/1994.aspx">&lt;&lt; ICallbackEventHandler changes in July CTP</a>
	...
	<a id="ctl06_PreviousNext_NextLink" title="next post" href="../../09/05/3118.aspx">Refactoring under VS 2005 (Whidbey) and ASP.Net &gt;&gt;</a>
</div>


<div class="entry">
	<h4><a id="ctl06_TitleUrl" title="Title of this entry." href="2876.aspx">ICallbackEventHandler changes again</a></h4>
	<p>I reported on the change from Beta2 of Visual Studio 2005 to the July CTP in a <a href="http://michaelteper.com/archive/2005/07/13/1994.aspx">previous post</a>. According to latest <a href="http://msdn.microsoft.com/asp.net/beta2/beta2rtmchanges/default.aspx">information from Microsoft</a>, the interface will undergo another change for RTM. Here it is from the horse's mouth:</p>
<blockquote dir="ltr" style="MARGIN-RIGHT: 0px">
<p>Callbacks enable ASP.NET controls to request data from the server using client script instead of posting back the page. For example, the TreeView control uses callbacks to populate child nodes when the parent node is expanded; this avoids the need to render the complete data hierarchy to the client on the initial page request. </p>
<p>Controls will typically retrieve data from a data source control during callback handling. All data source controls expose an asynchronous interface to data-bound controls, although it is possible for data source controls to be implemented synchronously. Although all built-in ASP.NET data source controls are implemented synchronously, the architecture for data controls supports writing asynchronous data source controls. A good example of an asynchronous data source control might be a WebServiceDataSource control.</p>
<p><b>Beta 2 Behavior</b></p>
<p>In Beta 2, data source controls implemented asynchronously do not work from a callback request, because the point at which the callback must be handled happens before the asynchronous completion point in the page request lifecycle. This precludes a data source control like the hypothetical WebServiceDataSource control from being used in a callback scenario. Because data-bound controls cannot determine whether a data source supports asynchronous callbacks, data-bound controls that perform a callback cannot implement special logic for handling asynchronous calls. More generally, any asynchronous callback in an asynchronous-enabled page fails. The failure does not raise an exception, it simply does not work.</p>
<p><b>RTM Behavior</b></p>
<p>The <code>ICallbackEventHandler</code> interface now includes an <code>Execute</code> method, which is called after the asynchronous completion point. The following example shows how the <code>Execute</code> method is called:</p><pre><code>public interface ICallbackEventHandler
{
    ...
    String Execute();
		...
		<p class="post">
			posted @ Monday, August 22, 2005 2:12 PM
		</p>
</div>
   ...
   <rdf:RDF 
      ...
      <rdf:Description
         rdf:about="http://www.michaelteper.com:443/archive/2005/08/22/2876.aspx"
         dc:identifier="http://www.michaelteper.com:443/archive/2005/08/22/2876.aspx"
         dc:title="ICallbackEventHandler changes again"
         trackback:ping="/services/trackbacks/2876.aspx" 
      />
   </rdf:RDF>
