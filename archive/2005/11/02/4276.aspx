...
<script type="text/javascript">
 ...
 var postTitle = "Seeing /MSOffice/cltreq.asp in your logs?";
 var postURL = "http://www.michaelteper.com:443/archive/2005/11/02/4276.aspx";
...
<script type="text/javascript" src="http://www.cocomment.com/js/cocomment.js">
	...
	<body>
		<form name="Form1" method="post" action="4276.aspx" id="Form1">
...
posts - 105, comments - 55, trackbacks - 1</div>
	<div id="switcher">
	    <a id="switchlink" href="4276.aspx#" title="Click here to change the content width" style="display:none;"><span></span></a>
	</div>
</div>
...
<div class="previousNext">
	<a id="ctl06_PreviousNext_PrevLink" title="previous post" href="../../09/22/3403.aspx">&lt;&lt; Season premiere of Lost kicked ass!</a>
	...
	<a id="ctl06_PreviousNext_NextLink" title="next post" href="../../12/02/4839.aspx">Farewell, my good friend... &gt;&gt;</a>
</div>


<div class="entry">
	<h4><a id="ctl06_TitleUrl" title="Title of this entry." href="4276.aspx">Seeing /MSOffice/cltreq.asp in your logs?</a></h4>
	<p>As any good web developer should, I have all errors generated by my websites logged and emailed to me. I've been seeing a number of 404's lately with the following request:</p>/MSOffice/cltreq.asp?UL=1&amp;ACT=4&amp;BUILD=5606&amp;STRMVER=4&amp;CAPREQ=0 
<p>If you are seeing this in your web logs, its because your users have Microsoft Office installed, and the discussion bar turned on in IE. IE is querying the server to see whether it supports web discussions.</p>
   ...
   <rdf:RDF 
      ...
      <rdf:Description
         rdf:about="http://www.michaelteper.com:443/archive/2005/11/02/4276.aspx"
         dc:identifier="http://www.michaelteper.com:443/archive/2005/11/02/4276.aspx"
         dc:title="Seeing /MSOffice/cltreq.asp in your logs?"
         trackback:ping="/services/trackbacks/4276.aspx" 
      />
   </rdf:RDF>
...
<div id="comments">
	...
	<p></p>
			...
			<div class="target comment">
				<h4>
					<a id="ctl08_CommentList_ctl00_EditCommentImgLink"></a><a title="permalink: re: Seeing /MSOffice/cltreq.asp in your logs?" href="4276.aspx#4158">#</a>&nbsp;<a name="4158"></a>re: Seeing /MSOffice/cltreq.asp in your logs?
				</h4>
				<div class="info">Left by <a id="ctl08_CommentList_ctl00_NameLink" title="http://www.ie7.com/" href="http://www.ie7.com/" target="_blank">John</a> at 9/18/2006 9:53 AM</div>
				<div class="gravatar"><img id="ctl08_CommentList_ctl00_GravatarImg" src="../../../../images/services/IdenticonHandler.ashx@code=1234267302" alt="Gravatar" width="50" border="0" /></div>
				<div class="post">
					<div>
						Wow, thanks for clearing that up, I alwasy wanted to know why I was seeing /MSOffice/cltreq.asp on my stats. Thanks
					</div>
