...
<script type="text/javascript">
 ...
 var postTitle = "How to write a unit test";
 var postURL = "http://www.michaelteper.com:443/archive/2005/12/04/4859.aspx";
...
<script type="text/javascript" src="http://www.cocomment.com/js/cocomment.js">
	...
	<body>
		<form name="Form1" method="post" action="4859.aspx" id="Form1">
...
posts - 105, comments - 55, trackbacks - 1</div>
	<div id="switcher">
	    <a id="switchlink" href="4859.aspx#" title="Click here to change the content width" style="display:none;"><span></span></a>
	</div>
</div>
...
<div class="previousNext">
	<a id="ctl06_PreviousNext_PrevLink" title="previous post" href="../02/4839.aspx">&lt;&lt; Farewell, my good friend...</a>
	...
	<a id="ctl06_PreviousNext_NextLink" title="next post" href="../14/4999.aspx">Custom HTTP error pages tip &gt;&gt;</a>
</div>


<div class="entry">
	<h4><a id="ctl06_TitleUrl" title="Title of this entry." href="4859.aspx">How to write a unit test</a></h4>
	<p><a href="http://jason.diamond.name/weblog">Jason Diamond</a> <a href="http://jason.diamond.name/weblog/2005/12/04/thoughts-on-setup-and-teardown-in-unit-tests">comments</a> on <a href="http://www.agileprogrammer.com/dotnetguy/">Brad Wilson</a>'s <a href="http://www.agileprogrammer.com/dotnetguy/articles/SetupTeardown.aspx">post about unit tests' SetUp and TearDown methods</a>. In the process, he lists some excellent general guidelines on how to structure your unit tests and fixtures. Definitely worth a read. Jason concludes:</p>
<blockquote dir="ltr" style="MARGIN-RIGHT: 0px">
<p>These days, I write a lot more fixtures. Each fixture has a unique SetUp method and the test cases usually contain nothing more than a single method call and one or two assertions. To figure out what the entire test case does, all I have to do is look at the SetUp method which, itself, is usually just a few lines of code. Getting to this point was initially pretty difficult but it’s gotten easier over time.</p></blockquote>

		<p class="post">
			posted @ Sunday, December 4, 2005 11:36 PM
		</p>
</div>
   ...
   <rdf:RDF 
      ...
      <rdf:Description
         rdf:about="http://www.michaelteper.com:443/archive/2005/12/04/4859.aspx"
         dc:identifier="http://www.michaelteper.com:443/archive/2005/12/04/4859.aspx"
         dc:title="How to write a unit test"
         trackback:ping="/services/trackbacks/4859.aspx" 
      />
   </rdf:RDF>
