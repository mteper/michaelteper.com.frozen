...
<script type="text/javascript">
 ...
 var postTitle = "Custom HTTP error pages tip";
 var postURL = "http://www.michaelteper.com:443/archive/2005/12/14/4999.aspx";
...
<script type="text/javascript" src="http://www.cocomment.com/js/cocomment.js">
	...
	<body>
		<form name="Form1" method="post" action="4999.aspx" id="Form1">
...
posts - 105, comments - 55, trackbacks - 1</div>
	<div id="switcher">
	    <a id="switchlink" href="4999.aspx#" title="Click here to change the content width" style="display:none;"><span></span></a>
	</div>
</div>
...
<div class="previousNext">
	<a id="ctl06_PreviousNext_PrevLink" title="previous post" href="../04/4859.aspx">&lt;&lt; How to write a unit test</a>
	...
	<a id="ctl06_PreviousNext_NextLink" title="next post" href="../22/5122.aspx">SEO Black Hat &gt;&gt;</a>
</div>


<div class="entry">
	<h4><a id="ctl06_TitleUrl" title="Title of this entry." href="4999.aspx">Custom HTTP error pages tip</a></h4>
	<p>Just a small reminder: if you are creating a customized page for a specific HTTP error, be sure to include code in the page to set the response error code appropriately.</p>
<p>For reference, see <a href="http://www.w3.org/Protocols/rfc2616/rfc2616-sec10.html">this</a> and <a href="http://www.w3.org/Protocols/rfc2616/rfc2616-sec6.html">this</a>.</p>
<p>For example, if you are using ASP.Net and are creating a custom 404 page, add this line to your Page_Load method:</p>
<p><font face="Courier New">Response.StatusCode = 404;</font></p>
   ...
   <rdf:RDF 
      ...
      <rdf:Description
         rdf:about="http://www.michaelteper.com:443/archive/2005/12/14/4999.aspx"
         dc:identifier="http://www.michaelteper.com:443/archive/2005/12/14/4999.aspx"
         dc:title="Custom HTTP error pages tip"
         trackback:ping="/services/trackbacks/4999.aspx" 
      />
   </rdf:RDF>
