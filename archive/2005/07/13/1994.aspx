...
<script type="text/javascript">
 ...
 var postTitle = "ICallbackEventHandler changes in July CTP";
 var postURL = "http://www.michaelteper.com:443/archive/2005/07/13/1994.aspx";
...
<script type="text/javascript" src="http://www.cocomment.com/js/cocomment.js">
	...
	<body>
		<form name="Form1" method="post" action="1994.aspx" id="Form1">
...
posts - 105, comments - 55, trackbacks - 1</div>
	<div id="switcher">
	    <a id="switchlink" href="1994.aspx#" title="Click here to change the content width" style="display:none;"><span></span></a>
	</div>
</div>
...
<div class="previousNext">
	<a id="ctl06_PreviousNext_PrevLink" title="previous post" href="../06/1554.aspx">&lt;&lt; ASP.Net 2.0 urlMappings (Web.config)</a>
	...
	<a id="ctl06_PreviousNext_NextLink" title="next post" href="../../08/22/2876.aspx">ICallbackEventHandler changes again &gt;&gt;</a>
</div>


<div class="entry">
	<h4><a id="ctl06_TitleUrl" title="Title of this entry." href="1994.aspx">ICallbackEventHandler changes in July CTP</a></h4>
	<p>Prior to the July CTP of VS 2005, the <strong>ICallbackEventHandler</strong> had just one method with the following signature:</p>
<p><font face="Courier New">string RaiseCallbackEvent (string <em>eventArgument</em>)</font></p>
<p>The <em>eventArgument</em> was the string that came from the client and the return string went back to the client.</p>
<p>In July CTP, the ASP.Net team split up the processing into two calls that now make up the <strong>ICallbackEventHandler</strong>:</p>
<p><font face="Courier New">void PrepareCallbackEvent (string <em>eventArgument</em>)<br />string RenderCallbackResult ()</font></p>
<p>The idea remains the same, you process the incoming data in <font face="Courier New">PrepareCallbackEvent</font> and put together the return payload in <font face="Courier New">RenderCallbackResult</font>.</p>
   ...
   <rdf:RDF 
      ...
      <rdf:Description
         rdf:about="http://www.michaelteper.com:443/archive/2005/07/13/1994.aspx"
         dc:identifier="http://www.michaelteper.com:443/archive/2005/07/13/1994.aspx"
         dc:title="ICallbackEventHandler changes in July CTP"
         trackback:ping="/services/trackbacks/1994.aspx" 
      />
   </rdf:RDF>
