...
<script type="text/javascript">
 ...
 var postTitle = "ASP.Net 2.0 urlMappings (Web.config)";
 var postURL = "http://www.michaelteper.com:443/archive/2005/07/06/1554.aspx";
...
<script type="text/javascript" src="http://www.cocomment.com/js/cocomment.js">
	...
	<body>
		<form name="Form1" method="post" action="1554.aspx" id="Form1">
...
posts - 105, comments - 55, trackbacks - 1</div>
	<div id="switcher">
	    <a id="switchlink" href="1554.aspx#" title="Click here to change the content width" style="display:none;"><span></span></a>
	</div>
</div>
...
<div class="previousNext">
	<a id="ctl06_PreviousNext_PrevLink" title="previous post" href="../05/1542.aspx">&lt;&lt; Things to check out in ASP.Net 2.0</a>
	...
	<a id="ctl06_PreviousNext_NextLink" title="next post" href="../13/1994.aspx">ICallbackEventHandler changes in July CTP &gt;&gt;</a>
</div>


<div class="entry">
	<h4><a id="ctl06_TitleUrl" title="Title of this entry." href="1554.aspx">ASP.Net 2.0 urlMappings (Web.config)</a></h4>
	<p>Following up to <a href="http://michaelteper.com/archive/2005/07/05/1542.aspx">my previous post</a>, the urlMappings section in Web.config allows one to configure rudimentary url rewriting.</p>
<p>For example, putting this into your <system.web>section:</system.web></p><font color="#0000ff" size="2">
<blockquote dir="ltr" style="MARGIN-RIGHT: 0px">
<p>&lt;</p></blockquote></font><font color="#800000" size="2">urlMappings</font><font color="#0000ff" size="2">&gt;<br />  &lt;</font><font color="#800000" size="2">add</font><font color="#0000ff" size="2"> </font><font color="#ff0000" size="2">url</font><font color="#0000ff" size="2">=</font><font size="2">"</font><font color="#0000ff" size="2">~/PageThatDoesNotExist.aspx</font><font size="2">"</font><font color="#0000ff" size="2"> </font><font color="#ff0000" size="2">mappedUrl</font><font color="#0000ff" size="2">=</font><font size="2">"</font><font color="#0000ff" size="2">~/RealPage.aspx</font><font size="2">"</font><font size="2"><font color="#0000ff"> /&gt;<br /></font></font><font color="#800000" size="2"><font color="#0000ff">&lt;</font>urlMappings</font><font color="#0000ff" size="2">&gt;</font> 
<p>will result in RealPage.aspx being rendered while the browser still thinks it reached PageThatDoesNotExist.aspx. One thing to note is that the URL must be application root relative. This was actually of interest to me since I wanted to do something similar but with a permanent redirect. It looks like in order to be able to do that, they had to bake urlMappings support pretty deep into the framework (way deeper than an HttpModule). Too bad.</p>
<p>If you know of a way to get ResolveUrl functionality in an HttpModule, please let me know!<font color="#0000ff" size="2"></font></p>
   ...
   <rdf:RDF 
      ...
      <rdf:Description
         rdf:about="http://www.michaelteper.com:443/archive/2005/07/06/1554.aspx"
         dc:identifier="http://www.michaelteper.com:443/archive/2005/07/06/1554.aspx"
         dc:title="ASP.Net 2.0 urlMappings (Web.config)"
         trackback:ping="/services/trackbacks/1554.aspx" 
      />
   </rdf:RDF>
