...
<script type="text/javascript">
 ...
 var postTitle = "SPAM: 1, Comments: 0";
 var postURL = "http://www.michaelteper.com:443/archive/2005/05/17/443.aspx";
...
<script type="text/javascript" src="http://www.cocomment.com/js/cocomment.js">
	...
	<body>
		<form name="Form1" method="post" action="443.aspx" id="Form1">
...
posts - 105, comments - 55, trackbacks - 1</div>
	<div id="switcher">
	    <a id="switchlink" href="443.aspx#" title="Click here to change the content width" style="display:none;"><span></span></a>
	</div>
</div>
...
<div class="previousNext">
	<a id="ctl06_PreviousNext_PrevLink" title="previous post" href="../../01/20/253.aspx">&lt;&lt; WinDiff, WinMerge, and other usual suspects</a>
	...
	<a id="ctl06_PreviousNext_NextLink" title="next post" href="../26/444.aspx">Page update frequency affects PageRank &gt;&gt;</a>
</div>


<div class="entry">
	<h4><a id="ctl06_TitleUrl" title="Title of this entry." href="443.aspx">SPAM: 1, Comments: 0</a></h4>
	<p>Over the past couple of weeks my blog received close to 150 spam comments and only 1 valid one. Given that I haven't blogged in a while (an infant and two jobs do that to you), deleting all the spam was starting to be too much of a burden. So, for the time being I've disabled comments. If you'd still like to be heard, please use the Contact link at <a href="http://www.MichaelTeper.com">www.MichaelTeper.com</a>.</p>
<p>I'll be watching the progress of <a href="http://haacked.com/archive/2005/05/04/2953.aspx">SubText</a> to see if the community comes up with a reasonable solution to this problem.</p>

		<p class="post">
			posted @ Tuesday, May 17, 2005 11:04 PM
		</p>
</div>
   ...
   <rdf:RDF 
      ...
      <rdf:Description
         rdf:about="http://www.michaelteper.com:443/archive/2005/05/17/443.aspx"
         dc:identifier="http://www.michaelteper.com:443/archive/2005/05/17/443.aspx"
         dc:title="SPAM: 1, Comments: 0"
         trackback:ping="/services/trackbacks/443.aspx" 
      />
   </rdf:RDF>
