...
<script type="text/javascript">
 ...
 var postTitle = "SlurpConfirm404";
 var postURL = "http://www.michaelteper.com:443/archive/2006/01/30/5705.aspx";
...
<script type="text/javascript" src="http://www.cocomment.com/js/cocomment.js">
	...
	<body>
		<form name="Form1" method="post" action="5705.aspx" id="Form1">
...
posts - 105, comments - 55, trackbacks - 1</div>
	<div id="switcher">
	    <a id="switchlink" href="5705.aspx#" title="Click here to change the content width" style="display:none;"><span></span></a>
	</div>
</div>
...
<div class="previousNext">
	<a id="ctl06_PreviousNext_PrevLink" title="previous post" href="../03/5307.aspx">&lt;&lt; SEO resources and Del.icio.us</a>
	...
	<a id="ctl06_PreviousNext_NextLink" title="next post" href="../31/5709.aspx">Google Toolbar 4 -- Custom buttons make it worth the switch &gt;&gt;</a>
</div>


<div class="entry">
	<h4><a id="ctl06_TitleUrl" title="Title of this entry." href="5705.aspx">SlurpConfirm404</a></h4>
	<p>I have <a href="http://www.NewRetirement.com">NewRetirement.com</a> set up to send me an email any time the site throws an error (including 404's). Its a great way to ensure that users receive a quality experience with the site, but its also quite informative. For example, you learn quite a bit about search engines by watching the behavior of their spiders. Yahoo! has been notoriosly slow about getting changes propagated through their system. We've moved some content around almost a year ago and set up 301 (permanent) redirects. While the Yahoo! slurp spider comes over frequently, on occasion it still requests old URL's. </p>
<p>What prompted me to write this post though was a new (to us) behavior of Yahoo! slurp. Today it threw a dozen or so requests at us for completely bogus URL's, all having this string in common: “SlurpConfirm404“. To Yahoo!'s credit, however, they do provide an explanation here:</p>
<p><a href="http://help.yahoo.com/help/us/ysearch/slurp/slurp-10.html">http://help.yahoo.com/help/us/ysearch/slurp/slurp-10.html</a></p>
   ...
   <rdf:RDF 
      ...
      <rdf:Description
         rdf:about="http://www.michaelteper.com:443/archive/2006/01/30/5705.aspx"
         dc:identifier="http://www.michaelteper.com:443/archive/2006/01/30/5705.aspx"
         dc:title="SlurpConfirm404"
         trackback:ping="/services/trackbacks/5705.aspx" 
      />
   </rdf:RDF>
