...
<script type="text/javascript">
 ...
 var postTitle = "Another SEO Google Toolbar Button";
 var postURL = "http://www.michaelteper.com:443/archive/2006/05/05/AnotherSEOGoogleToolbarButton.aspx";
...
<script type="text/javascript" src="http://www.cocomment.com/js/cocomment.js">
	...
	<body>
		<form name="Form1" method="post" action="AnotherSEOGoogleToolbarButton.aspx" id="Form1">
...
posts - 105, comments - 55, trackbacks - 1</div>
	<div id="switcher">
	    <a id="switchlink" href="AnotherSEOGoogleToolbarButton.aspx#" title="Click here to change the content width" style="display:none;"><span></span></a>
	</div>
</div>
...
<div class="previousNext">
	<a id="ctl06_PreviousNext_PrevLink" title="previous post" href="../../04/02/SophiaTeperthefilmmaker.aspx">&lt;&lt; Sophia Teper the filmmaker</a>
	...
	<a id="ctl06_PreviousNext_NextLink" title="next post" href="../../06/06/PhotoSharingServiceReviewZenfolioVsImageStation.aspx">Photosharing service comparison and review: Zenfolio vs. ImageStation &gt;&gt;</a>
</div>


<div class="entry">
	<h4><a id="ctl06_TitleUrl" title="Title of this entry." href="AnotherSEOGoogleToolbarButton.aspx">Another SEO Google Toolbar Button</a></h4>
	<p>This one is for StatBrain. Their algorithm appears close enough in my testing to warrant checking domains against.</p>
<p>Click here to add button:</p>
<p><a href="http://toolbar.google.com/buttons/add?url=http://www.michaelteper.com/GoogleButtons/statbrain.xml">http://toolbar.google.com/buttons/add?url=http://www.michaelteper.com/GoogleButtons/statbrain.xml</a></p>

		<p class="post">
			posted @ Friday, May 5, 2006 6:24 PM
		</p>
</div>
   ...
   <rdf:RDF 
      ...
      <rdf:Description
         rdf:about="http://www.michaelteper.com:443/archive/2006/05/05/AnotherSEOGoogleToolbarButton.aspx"
         dc:identifier="http://www.michaelteper.com:443/archive/2006/05/05/AnotherSEOGoogleToolbarButton.aspx"
         dc:title="Another SEO Google Toolbar Button"
         trackback:ping="/services/trackbacks/7521.aspx" 
      />
   </rdf:RDF>
