...
<script type="text/javascript">
 ...
 var postTitle = "Goodbye .Text, Hello SubText";
 var postURL = "http://www.michaelteper.com:443/archive/2006/03/14/6157.aspx";
...
<script type="text/javascript" src="http://www.cocomment.com/js/cocomment.js">
	...
	<body>
		<form name="Form1" method="post" action="6157.aspx" id="Form1">
...
posts - 105, comments - 55, trackbacks - 1</div>
	<div id="switcher">
	    <a id="switchlink" href="6157.aspx#" title="Click here to change the content width" style="display:none;"><span></span></a>
	</div>
</div>
...
<div class="previousNext">
	<a id="ctl06_PreviousNext_PrevLink" title="previous post" href="../../02/27/6150.aspx">&lt;&lt; REST vs SOAP</a>
	...
	<a id="ctl06_PreviousNext_NextLink" title="next post" href="../17/Google_Hiring_Strategy.aspx">Google hiring strategy &gt;&gt;</a>
</div>


<div class="entry">
	<h4><a id="ctl06_TitleUrl" title="Title of this entry." href="6157.aspx">Goodbye .Text, Hello SubText</a></h4>
	<p><a href="http://www.haacked.com">Mr. Haack</a> and crew finally made a public release of <a href="http://www.subtextproject.com">SubText</a> available and I jumped at the opportunity to upgrade from .Text.</p>
<p>My impressions thus far:</p>
<ul>
<li>they really nailed the install and migration experience, kudos! 
</li><li>I like the new skins, I wish there were more 
</li><li>The admin interface got a patchy here-and-there facelift, but the layout is messed up in IE, bummer. 
</li><li>Its still not the engine for blog monetization (admittedly, that isn't a project goal) 
</li><li>I was hoping to see verbose URL's but its pretty far off on the roadmap, not sure why (doesnt seem like a complex feature). It would be very helpful for SEO purposes.</li></ul>
<p>I'll play with the skins some more over the coming days and weeks...</p>
<p>Thanks!</p>
   ...
   <rdf:RDF 
      ...
      <rdf:Description
         rdf:about="http://www.michaelteper.com:443/archive/2006/03/14/6157.aspx"
         dc:identifier="http://www.michaelteper.com:443/archive/2006/03/14/6157.aspx"
         dc:title="Goodbye .Text, Hello SubText"
         trackback:ping="/services/trackbacks/6157.aspx" 
      />
   </rdf:RDF>
...
<div id="comments">
	...
	<p></p>
			...
			<div class="target comment">
				<h4>
					<a id="ctl08_CommentList_ctl00_EditCommentImgLink"></a><a title="permalink: re: Goodbye .Text, Hello SubText" href="6157.aspx#285">#</a>&nbsp;<a name="285"></a>re: Goodbye .Text, Hello SubText
				</h4>
				<div class="info">Left by <a id="ctl08_CommentList_ctl00_NameLink" title="http://haacked.com/" href="http://haacked.com/" target="_blank">Haacked</a> at 3/17/2006 5:14 AM</div>
				<div class="gravatar"><img id="ctl08_CommentList_ctl00_GravatarImg" src="../../../../images/services/IdenticonHandler.ashx@code=-1424389534" alt="Gravatar" width="50" border="0" /></div>
				<div class="post">
					<div>
						THanks for the review.  What do you mean by Verbose URLs?<br /><br />As for blog monetization, what features would you like to see to that end?  The obvious one we can think of is adding an Ad-Sense control that can easily be attached to a skin.
					</div>
