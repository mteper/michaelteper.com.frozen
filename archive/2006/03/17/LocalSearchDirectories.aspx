...
<script type="text/javascript">
 ...
 var postTitle = "Local Search Directories";
 var postURL = "http://www.michaelteper.com:443/archive/2006/03/17/LocalSearchDirectories.aspx";
...
<script type="text/javascript" src="http://www.cocomment.com/js/cocomment.js">
	...
	<body>
		<form name="Form1" method="post" action="LocalSearchDirectories.aspx" id="Form1">
...
posts - 105, comments - 55, trackbacks - 1</div>
	<div id="switcher">
	    <a id="switchlink" href="LocalSearchDirectories.aspx#" title="Click here to change the content width" style="display:none;"><span></span></a>
	</div>
</div>
...
<div class="previousNext">
	<a id="ctl06_PreviousNext_PrevLink" title="previous post" href="SubmitYourBusinesstoGoogleLocalSearch.aspx">&lt;&lt; Submit Your Business to Google Local Search</a>
	...
	<a id="ctl06_PreviousNext_NextLink" title="next post" href="../22/Similiciousgoogletoolbarbutton.aspx">Similicio.us google toolbar button &gt;&gt;</a>
</div>


<div class="entry">
	<h4><a id="ctl06_TitleUrl" title="Title of this entry." href="LocalSearchDirectories.aspx">Local Search Directories</a></h4>
	<p>Mostly to remind myself, this is a list of local search directories and data aggregators with corresponding submit/edit links:</p>
<ul>
...
<p>Have I missed any?</p>
		...
		<p class="post">
			posted @ Friday, March 17, 2006 12:11 PM
		</p>
</div>
   ...
   <rdf:RDF 
      ...
      <rdf:Description
         rdf:about="http://www.michaelteper.com:443/archive/2006/03/17/LocalSearchDirectories.aspx"
         dc:identifier="http://www.michaelteper.com:443/archive/2006/03/17/LocalSearchDirectories.aspx"
         dc:title="Local Search Directories"
         trackback:ping="/services/trackbacks/6173.aspx" 
      />
   </rdf:RDF>
...
<div id="comments">
	...
	<p></p>
			...
			<div class="target comment">
				<h4>
					<a id="ctl08_CommentList_ctl00_EditCommentImgLink"></a><a title="permalink: re: Local Search Directories" href="LocalSearchDirectories.aspx#2156">#</a>&nbsp;<a name="2156"></a>re: Local Search Directories
				</h4>
				<div class="info">Left by <a id="ctl08_CommentList_ctl00_NameLink" title="david r. kriebel contractor" target="_blank">david r. kriebel contractor</a> at 9/27/2006 10:34 AM</div>
				<div class="gravatar"><img id="ctl08_CommentList_ctl00_GravatarImg" src="../../../../images/services/IdenticonHandler.ashx@code=1152524245" alt="Gravatar" width="50" border="0" /></div>
				<div class="post">
					<div>
						trying to find merchantcircle.com for negative comments on this business
					</div>
