...
<script type="text/javascript">
 ...
 var postTitle = "Google hiring strategy";
 var postURL = "http://www.michaelteper.com:443/archive/2006/03/17/Google_Hiring_Strategy.aspx";
...
<script type="text/javascript" src="http://www.cocomment.com/js/cocomment.js">
	...
	<body>
		<form name="Form1" method="post" action="Google_Hiring_Strategy.aspx" id="Form1">
...
posts - 105, comments - 55, trackbacks - 1</div>
	<div id="switcher">
	    <a id="switchlink" href="Google_Hiring_Strategy.aspx#" title="Click here to change the content width" style="display:none;"><span></span></a>
	</div>
</div>
...
<div class="previousNext">
	<a id="ctl06_PreviousNext_PrevLink" title="previous post" href="../14/6157.aspx">&lt;&lt; Goodbye .Text, Hello SubText</a>
	...
	<a id="ctl06_PreviousNext_NextLink" title="next post" href="HowtoSubmitYourWebsitetoYahoo!Local.aspx">How to Submit Your Website to Yahoo! Local &gt;&gt;</a>
</div>


<div class="entry">
	<h4><a id="ctl06_TitleUrl" title="Title of this entry." href="Google_Hiring_Strategy.aspx">Google hiring strategy</a></h4>
	Peter Norvig, Director of Google Research recently <a href="http://googleresearch.blogspot.com/2006/03/hiring-lake-wobegon-strategy.html">described the "Lake Wobegon" hiring strategy</a> and contrasted it with two other strategies he dubbed "dot-com boom" and "hiring manager centric". The data is compelling and is worth considering, however I question the claim that Google hires people at the company level and then assigns them to projects (rather than hiring into project groups). That's just not been my experience (disclaimer: I don't work for Google so "my experience" is conjecture based on hearsay and public job descriptions).

		<p class="post">
			posted @ Friday, March 17, 2006 11:07 AM
		</p>
</div>
   ...
   <rdf:RDF 
      ...
      <rdf:Description
         rdf:about="http://www.michaelteper.com:443/archive/2006/03/17/Google_Hiring_Strategy.aspx"
         dc:identifier="http://www.michaelteper.com:443/archive/2006/03/17/Google_Hiring_Strategy.aspx"
         dc:title="Google hiring strategy"
         trackback:ping="/services/trackbacks/6170.aspx" 
      />
   </rdf:RDF>
