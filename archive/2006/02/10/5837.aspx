...
<script type="text/javascript">
 ...
 var postTitle = "Google Sitemaps robots.txt tool lies";
 var postURL = "http://www.michaelteper.com:443/archive/2006/02/10/5837.aspx";
...
<script type="text/javascript" src="http://www.cocomment.com/js/cocomment.js">
	...
	<body>
		<form name="Form1" method="post" action="5837.aspx" id="Form1">
...
posts - 105, comments - 55, trackbacks - 1</div>
	<div id="switcher">
	    <a id="switchlink" href="5837.aspx#" title="Click here to change the content width" style="display:none;"><span></span></a>
	</div>
</div>
...
<div class="previousNext">
	<a id="ctl06_PreviousNext_PrevLink" title="previous post" href="../09/5825.aspx">&lt;&lt; Aaron Wall posts some more SEO Buttons for Google toolbar</a>
	...
	<a id="ctl06_PreviousNext_NextLink" title="next post" href="../13/5907.aspx">Best blond joke ever! &gt;&gt;</a>
</div>


<div class="entry">
	<h4><a id="ctl06_TitleUrl" title="Title of this entry." href="5837.aspx">Google Sitemaps robots.txt tool lies</a></h4>
	<p>[<strong>Update 2/14/06</strong>: checked again today and problem appears fixed. Score one for Google.]</p>
<p>Last week, Google released an update to <a href="http://www.google.com/webmasters/sitemaps/">Google Sitemaps</a> that added a robots.txt checker tool. I started experimenting with it today and found a rather odd behavior: the tool reports access allowed for terms that clearly should not be. I think I've got this boiled down to the simplest case, which appears to have to do with terms starting with “Web” (”W” has to be capitalized). I don't know whether this is domain specific, so I'd love to hear back whether you are able to reproduce this or not. Here's the setup:</p>
<p>Enter the following into the large robots.txt area:<br /><font face="Courier New">User-agent: *<br />Disallow: /Web.htm</font></p>
<p>Then enter the following into the URL area:<br /><font face="Courier New">http://www.[your domain here]<your name="" domain="">.com/Web.htm</your></font></p>
<p>Now, click “Check” and watch it report “Allowed”.</p>
<p>If you happen to see this and know someone at Google, pass it along.</p>
   ...
   <rdf:RDF 
      ...
      <rdf:Description
         rdf:about="http://www.michaelteper.com:443/archive/2006/02/10/5837.aspx"
         dc:identifier="http://www.michaelteper.com:443/archive/2006/02/10/5837.aspx"
         dc:title="Google Sitemaps robots.txt tool lies"
         trackback:ping="/services/trackbacks/5837.aspx" 
      />
   </rdf:RDF>
