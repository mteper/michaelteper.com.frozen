...
<script type="text/javascript">
 ...
 var postTitle = "Are you an arrogant web designer?";
 var postURL = "http://www.michaelteper.com:443/archive/2006/02/23/6076.aspx";
...
<script type="text/javascript" src="http://www.cocomment.com/js/cocomment.js">
	...
	<body>
		<form name="Form1" method="post" action="6076.aspx" id="Form1">
...
posts - 105, comments - 55, trackbacks - 1</div>
	<div id="switcher">
	    <a id="switchlink" href="6076.aspx#" title="Click here to change the content width" style="display:none;"><span></span></a>
	</div>
</div>
...
<div class="previousNext">
	<a id="ctl06_PreviousNext_PrevLink" title="previous post" href="../16/5967.aspx">&lt;&lt; Black Hat SEO in a White Hat world</a>
	...
	<a id="ctl06_PreviousNext_NextLink" title="next post" href="../24/6088.aspx">I got Dugg! &gt;&gt;</a>
</div>


<div class="entry">
	<h4><a id="ctl06_TitleUrl" title="Title of this entry." href="6076.aspx">Are you an arrogant web designer?</a></h4>
	<p>If you are the person responsible for <a href="http://www.bloglines.com">BlogLines</a>, you are.</p>
<p>Before I get into my rant, let me classify site designs into three buckets:</p>
<ul>
<li><strong>Arrogant</strong>: common among Mac and Linux people. They discount windows and Internet Explorer on religious grounds, code up page layouts to look good in their favorite browser (FireFox, Safari) and assume that because their browser of choice is known to be fairly standards compliant, their work is therefore standards compliant. <br /><br />There are two fallacies with this approach: first, just because browser X renders something one way, it does not necessarily mean that that is the <em>right</em> way (either due to bugs or ambiguity in the standard definition) and, more importantly, they've completely ignored the user.<br /><br />You can code to standards all you want and have it look right in FireFox, but if over half of your website visitors use IE and the page is broken in IE, guess what -- you are saying to your visitors that they are morons and you know better -- i.e. you are (an) arrogant (fool). 
</li><li><strong>Sloppy</strong>: you know that 90% of your visitors use IE, and so you code to that browser and never even check how things look in your second most popular browser. Needless to say, this trait is common among Microsoft developers. It is sloppy because without checking, there is no way to know how the website looks to the other 10% and so an intelligent decision can't be made about whether or not the effort to satisfy all 100% of the website visitors is worthwhile. Chances are, if a site is coded to IE and it looks different in FireFox, the effort to fix things up may be pretty small. 
</li><li><strong>Responsible</strong>: a responsible web designer knows her audience from empiric data, tests on at least the top three browsers, and makes informed decisions about tradeoffs of fully supporting each browser platform. For bonus points, a responsible web designer notifies visitors whose experience with the website may be sub par due to their browser choice and informs them of their options.</li></ul>
<p>So lets bring it back to BlogLines. Fire it up in FireFox and it looks peachy (except for a bunch of CSS errors, but we won't go there). Now fire it up in IE. Looks pretty good, right? Try moving your mouse over the active navigation tab (most likely “My Feeds“). One of two things will happen: best case, you'll get a quick flicker and the mouse cursor will quickly change to hourglass and back. Worst case, the background will briefly flash though.</p>
<p>An argument can be made that this is not a big deal, the site works just fine after all, and maybe discount this as sloppy. But its more than that. This is the sort of thing that a lot of people will experience and it will contribute to their impression of the site (conscious or otherwise). The fact that this will be experienced by the majority of the web site's visitors is what makes this an <strong>arrogant</strong> omission rather than just a <strong>sloppy</strong> one.</p>
<p>Root cause: the designer implemented a rollover technique with pure CSS. What happens though is that IE tries to retrieve the image on each rollover and the combination of the state of the browser cache and network conditions can conspire to force a noticeable lag time while the image is loaded. Yes, FireFox handles this better. Bottom line though -- user experience is impacted for the majority of the site's visitors. Fix? Easy: preload images. It may not be as simple or elegant, but who are you trying to impress? It should be your users!</p>
<p>So don't be an arrogant web designer -- remember who you are doing this for.</p>
   ...
   <rdf:RDF 
      ...
      <rdf:Description
         rdf:about="http://www.michaelteper.com:443/archive/2006/02/23/6076.aspx"
         dc:identifier="http://www.michaelteper.com:443/archive/2006/02/23/6076.aspx"
         dc:title="Are you an arrogant web designer?"
         trackback:ping="/services/trackbacks/6076.aspx" 
      />
   </rdf:RDF>
