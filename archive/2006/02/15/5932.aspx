...
<script type="text/javascript">
 ...
 var postTitle = "Google Sitemaps robots.txt tool fixed!";
 var postURL = "http://www.michaelteper.com:443/archive/2006/02/15/5932.aspx";
...
<script type="text/javascript" src="http://www.cocomment.com/js/cocomment.js">
	...
	<body>
		<form name="Form1" method="post" action="5932.aspx" id="Form1">
...
posts - 105, comments - 55, trackbacks - 1</div>
	<div id="switcher">
	    <a id="switchlink" href="5932.aspx#" title="Click here to change the content width" style="display:none;"><span></span></a>
	</div>
</div>
...
<div class="previousNext">
	<a id="ctl06_PreviousNext_PrevLink" title="previous post" href="../14/5922.aspx">&lt;&lt; CompositeDataBoundControl explained</a>
	...
	<a id="ctl06_PreviousNext_NextLink" title="next post" href="../16/5967.aspx">Black Hat SEO in a White Hat world &gt;&gt;</a>
</div>


<div class="entry">
	<h4><a id="ctl06_TitleUrl" title="Title of this entry." href="5932.aspx">Google Sitemaps robots.txt tool fixed!</a></h4>
	<p>A few days ago I wrote about <a href="http://michaelteper.com/archive/2006/02/10/5837.aspx">an issue with Google's new sitemaps robots.txt checker</a>. I am happy to report they've appeared to address the problem. I suspect a possible catalyst for the fix was my comment on <a href="http://mattcutts.com/blog/">Matt Cutts' blog</a> reporting this issue (of course I am assuming I was the only one to notice this!). The odd thing is that Matt had since deleted my comment, but as long as the fix is in I'm not complaining.</p>

		<p class="post">
			posted @ Wednesday, February 15, 2006 12:26 AM
		</p>
</div>
   ...
   <rdf:RDF 
      ...
      <rdf:Description
         rdf:about="http://www.michaelteper.com:443/archive/2006/02/15/5932.aspx"
         dc:identifier="http://www.michaelteper.com:443/archive/2006/02/15/5932.aspx"
         dc:title="Google Sitemaps robots.txt tool fixed!"
         trackback:ping="/services/trackbacks/5932.aspx" 
      />
   </rdf:RDF>
