...
<script type="text/javascript">
 ...
 var postTitle = "Hiram Mann's "No man survives when freedom fails"";
 var postURL = "http://www.michaelteper.com:443/archive/2006/12/22/Hiram-Manns-No-man-survices-when-freedom-fails.aspx";
...
<script type="text/javascript" src="http://www.cocomment.com/js/cocomment.js">
	...
	<body>
		<form name="Form1" method="post" action="Hiram-Manns-No-man-survices-when-freedom-fails.aspx" id="Form1">
...
posts - 105, comments - 55, trackbacks - 1</div>
	<div id="switcher">
	    <a id="switchlink" href="Hiram-Manns-No-man-survices-when-freedom-fails.aspx#" title="Click here to change the content width" style="display:none;"><span></span></a>
	</div>
</div>
...
<div class="previousNext">
	<a id="ctl06_PreviousNext_PrevLink" title="previous post" href="../../06/06/PhotoSharingServiceReviewZenfolioVsImageStation.aspx">&lt;&lt; Photosharing service comparison and review: Zenfolio vs. ImageStation</a>
	...
	<a id="ctl06_PreviousNext_NextLink" title="next post" href="../../../2007/02/28/How-to-reenable-Hibernate-on-Windows-Vista.aspx">How to re-enable Hibernate on Windows Vista &gt;&gt;</a>
</div>


<div class="entry">
	<h4><a id="ctl06_TitleUrl" title="Title of this entry." href="Hiram-Manns-No-man-survices-when-freedom-fails.aspx">Hiram Mann's "No man survives when freedom fails"</a></h4>
	<p>Its been a while since I had time to blog, but this seemed worthwhile. I ran across a short poem by Hiram Mann that goes something like this:</p>
...
<p dir="ltr">I say "something like" because there appear multiple variations online. If you can point to an authoritative source, please drop me a note.</p>

		<p class="post">
			posted @ Friday, December 22, 2006 8:54 AM
		</p>
</div>
   ...
   <rdf:RDF 
      ...
      <rdf:Description
         rdf:about="http://www.michaelteper.com:443/archive/2006/12/22/Hiram-Manns-No-man-survices-when-freedom-fails.aspx"
         dc:identifier="http://www.michaelteper.com:443/archive/2006/12/22/Hiram-Manns-No-man-survices-when-freedom-fails.aspx"
         dc:title="Hiram Mann's "No man survives when freedom fails""
         trackback:ping="/services/trackbacks/28505.aspx" 
      />
   </rdf:RDF>
