...
<script type="text/javascript">
 ...
 var postTitle = "Recent lolcat favorites";
 var postURL = "http://www.michaelteper.com:443/archive/2007/12/06/a-recent-lolcat-favorite.aspx";
...
<script type="text/javascript" src="http://www.cocomment.com/js/cocomment.js">
	...
	<body>
		<form name="Form1" method="post" action="a-recent-lolcat-favorite.aspx" id="Form1">
...
posts - 105, comments - 55, trackbacks - 1</div>
	<div id="switcher">
	    <a id="switchlink" href="a-recent-lolcat-favorite.aspx#" title="Click here to change the content width" style="display:none;"><span></span></a>
	</div>
</div>
...
<div class="previousNext">
	<a id="ctl06_PreviousNext_PrevLink" title="previous post" href="../../02/28/How-to-reenable-Hibernate-on-Windows-Vista.aspx">&lt;&lt; How to re-enable Hibernate on Windows Vista</a>
	...
	<a id="ctl06_PreviousNext_NextLink" title="next post" href="../../../2008/05/13/an-error-occurred-while-using-the-bcp-utility.aspx">An error occurred while using the BCP utility &gt;&gt;</a>
</div>


<div class="entry">
	<h4><a id="ctl06_TitleUrl" title="Title of this entry." href="a-recent-lolcat-favorite.aspx">Recent lolcat favorites</a></h4>
	<p>I decided to keep a running post of LolCat favorites. I rely on these and Dilbert for my daily chuckle.</p>
...
moar <a href="http://icanhascheezburger.com">funny pictures</a>
   ...
   <rdf:RDF 
      ...
      <rdf:Description
         rdf:about="http://www.michaelteper.com:443/archive/2007/12/06/a-recent-lolcat-favorite.aspx"
         dc:identifier="http://www.michaelteper.com:443/archive/2007/12/06/a-recent-lolcat-favorite.aspx"
         dc:title="Recent lolcat favorites"
         trackback:ping="/services/trackbacks/28508.aspx" 
      />
   </rdf:RDF>
