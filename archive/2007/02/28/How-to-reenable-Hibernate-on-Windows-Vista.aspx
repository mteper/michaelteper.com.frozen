...
<script type="text/javascript">
 ...
 var postTitle = "How to re-enable Hibernate on Windows Vista";
 var postURL = "http://www.michaelteper.com:443/archive/2007/02/28/How-to-reenable-Hibernate-on-Windows-Vista.aspx";
...
<script type="text/javascript" src="http://www.cocomment.com/js/cocomment.js">
	...
	<body>
		<form name="Form1" method="post" action="How-to-reenable-Hibernate-on-Windows-Vista.aspx" id="Form1">
...
posts - 105, comments - 55, trackbacks - 1</div>
	<div id="switcher">
	    <a id="switchlink" href="How-to-reenable-Hibernate-on-Windows-Vista.aspx#" title="Click here to change the content width" style="display:none;"><span></span></a>
	</div>
</div>
...
<div class="previousNext">
	<a id="ctl06_PreviousNext_PrevLink" title="previous post" href="../../../2006/12/22/Hiram-Manns-No-man-survices-when-freedom-fails.aspx">&lt;&lt; Hiram Mann's &quot;No man survives when freedom fails&quot;</a>
	...
	<a id="ctl06_PreviousNext_NextLink" title="next post" href="../../12/06/a-recent-lolcat-favorite.aspx">Recent lolcat favorites &gt;&gt;</a>
</div>


<div class="entry">
	<h4><a id="ctl06_TitleUrl" title="Title of this entry." href="How-to-reenable-Hibernate-on-Windows-Vista.aspx">How to re-enable Hibernate on Windows Vista</a></h4>
	<p>Windows Vista allows you to reclaim some hard drive space by removing the hibernation system file via the Disc Cleanup Wizard. What happens though is that once you do that, the option to hibernate is gone. Its not in the shutdown options, its not in the power options, its just gone.</p>
...
<p>Voila, you've got Hibernate back!</p>

		<p class="post">
			posted @ Wednesday, February 28, 2007 8:42 AM
		</p>
</div>
   ...
   <rdf:RDF 
      ...
      <rdf:Description
         rdf:about="http://www.michaelteper.com:443/archive/2007/02/28/How-to-reenable-Hibernate-on-Windows-Vista.aspx"
         dc:identifier="http://www.michaelteper.com:443/archive/2007/02/28/How-to-reenable-Hibernate-on-Windows-Vista.aspx"
         dc:title="How to re-enable Hibernate on Windows Vista"
         trackback:ping="/services/trackbacks/28506.aspx" 
      />
   </rdf:RDF>
