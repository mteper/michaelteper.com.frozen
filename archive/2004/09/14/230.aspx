...
<script type="text/javascript">
 ...
 var postTitle = "Animal Cruelty";
 var postURL = "http://www.michaelteper.com:443/archive/2004/09/14/230.aspx";
...
<script type="text/javascript" src="http://www.cocomment.com/js/cocomment.js">
	...
	<body>
		<form name="Form1" method="post" action="230.aspx" id="Form1">
...
posts - 105, comments - 55, trackbacks - 1</div>
	<div id="switcher">
	    <a id="switchlink" href="230.aspx#" title="Click here to change the content width" style="display:none;"><span></span></a>
	</div>
</div>
...
<div class="previousNext">
	<a id="ctl06_PreviousNext_PrevLink" title="previous post" href="../13/229.aspx">&lt;&lt; Top 10 Criteria Investors Want To See in a Business Plan</a>
	...
	<a id="ctl06_PreviousNext_NextLink" title="next post" href="../20/231.aspx">Preview RAW camera files in Microsoft Picture and Fax Viewer &gt;&gt;</a>
</div>


<div class="entry">
	<h4><a id="ctl06_TitleUrl" title="Title of this entry." href="230.aspx">Animal Cruelty</a></h4>
	<p>I eat meat and I have no illusions about where it comes from. Like it or not, we are a carnivorous species and the meat industry has grown out of a real necessity. But that is not what this post is about. I think intentional animal cruelty, such as <a href="http://weblogs.asp.net/saraford/archive/2004/09/08/227001.aspx">encountered and described by Sara Ford</a> is just unforgivable. Yes, it is too often that people take on pets without realizing the full extent of the burden they take on, but one has to take responsibility for one's actions. As the absolute last resort, if you are not able to take good care of a pet, you should make damn sure you arrange for someone else that can.</p>
<p>What Sara encoutered may, of course, have been even worse - a prank someone played on the pets and their owners by abducting and stranding the animals. I can only hope that there is a way to criminally punish such behavior (perhaps as theft? cruelty to animals?).</p>

		<p class="post">
			posted @ Tuesday, September 14, 2004 11:10 PM
		</p>
</div>
   ...
   <rdf:RDF 
      ...
      <rdf:Description
         rdf:about="http://www.michaelteper.com:443/archive/2004/09/14/230.aspx"
         dc:identifier="http://www.michaelteper.com:443/archive/2004/09/14/230.aspx"
         dc:title="Animal Cruelty"
         trackback:ping="/services/trackbacks/230.aspx" 
      />
   </rdf:RDF>
...
<div id="comments">
	...
	<p></p>
			...
			<div class="target comment">
				<h4>
					<a id="ctl08_CommentList_ctl00_EditCommentImgLink"></a><a title="permalink: re: Animal Cruelty" href="230.aspx#273">#</a>&nbsp;<a name="273"></a>re: Animal Cruelty
				</h4>
				<div class="info">Left by <a id="ctl08_CommentList_ctl00_NameLink" title="-N/A-" target="_blank">-N/A-</a> at 2/28/2006 2:51 AM</div>
				<div class="gravatar"><img id="ctl08_CommentList_ctl00_GravatarImg" src="../../../../images/services/IdenticonHandler.ashx@code=-867413297" alt="Gravatar" width="50" border="0" /></div>
				<div class="post">
					<div>
						Damn straight. Animal cruelty needs to be stopped, and soon.
					</div>
			...
			<div class="target comment">
				<h4>
					<a id="ctl08_CommentList_ctl01_EditCommentImgLink"></a><a title="permalink: re: Animal Cruelty" href="230.aspx#18139">#</a>&nbsp;<a name="18139"></a>re: Animal Cruelty
				</h4>
				<div class="info">Left by <a id="ctl08_CommentList_ctl01_NameLink" title="Trisha" target="_blank">Trisha</a> at 6/1/2006 5:55 AM</div>
				<div class="gravatar"><img id="ctl08_CommentList_ctl01_GravatarImg" src="../../../../images/services/IdenticonHandler.ashx@code=-411529215" alt="Gravatar" width="50" border="0" /></div>
				<div class="post">
					<div>
						Its sad that people consider cows and chickens and pigs to be different than dogs and cats. Its okay to harvest an animal and treat them inhumanely as long as its not a housepet? How would you feel if I ate your dog? Not good right...yet a judge in san diego deemed it okay for chicken producers to throw 30,000 live chickens into a wood chipper simply because they couldn't reproduce, their production was slow, or because they were male...how convenient. 
					</div>
					<span class="adminLink">
