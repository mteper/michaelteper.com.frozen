...
<script type="text/javascript">
 ...
 var postTitle = "San Francisco Bay Area police speed traps";
 var postURL = "http://www.michaelteper.com:443/archive/2004/09/01/220.aspx";
...
<script type="text/javascript" src="http://www.cocomment.com/js/cocomment.js">
	...
	<body>
		<form name="Form1" method="post" action="220.aspx" id="Form1">
...
posts - 105, comments - 55, trackbacks - 1</div>
	<div id="switcher">
	    <a id="switchlink" href="220.aspx#" title="Click here to change the content width" style="display:none;"><span></span></a>
	</div>
</div>
...
<div class="previousNext">
	<a id="ctl06_PreviousNext_PrevLink" title="previous post" href="../../08/29/217.aspx">&lt;&lt; Will Visual Studio .Net 2005 be delayed into 2006?</a>
	...
	<a id="ctl06_PreviousNext_NextLink" title="next post" href="../02/225.aspx">Simple .Net screen ruler (awesome!) &gt;&gt;</a>
</div>


<div class="entry">
	<h4><a id="ctl06_TitleUrl" title="Title of this entry." href="220.aspx">San Francisco Bay Area police speed traps</a></h4>
	<p>I took a driving school class the other week, which was actually pretty good. Granted, my expectations were pretty low as the last time I sat through traffic school some 5 years ago, I remember it being one of the most tortured experiences of my life. Still, this time around the time flew by pretty quickly and I was never bored. If you ever find yourself needing to attend, give the Lettuce Amuse U Comedy Traffic School a buzz at 800-286-8051. For the record, my instructor's name was Mik Berry. Keep in mind, this is by far not the cheapest traffic school around but I chose them because they offered weekday classes.</p>
<p>So, what important facts did I learn in traffic school? Well, first off, the fact that most people were these for speeding. Given that that was the theme, here's an informal list of top police speed traps, mostly in North Bay. If you find any errors, please leave me a comment.</p>
<ul>
<li>Bridgeway, in Sausalito</li>
<li>Blackie's Pasture, in Tiburon</li>
<li>East Blithedale, in Sausalito</li>
<li>Rancho Nicacio</li>
<li>Near Tam High School (45 becomes 30)</li>
<li>Near Drake High School (on Sir Francis Drake)</li>
<li>Bottom of the hill on Hwy 37, near 101</li>
<li>Central San Rafael, 2nd St -&gt; 101 onramp.</li>
<li>and, of course, 101 anywhere in Marin county -- the 4 lane hwy has a 55mph speed limit</li></ul>
<p>Also, a useful, if not suprising, statistic: 60% of people stopped for speeding are travelling in the far left lane, 30% in the 2nd lane from the left.</p>

		<p class="post">
			posted @ Wednesday, September 1, 2004 1:18 PM
		</p>
</div>
   ...
   <rdf:RDF 
      ...
      <rdf:Description
         rdf:about="http://www.michaelteper.com:443/archive/2004/09/01/220.aspx"
         dc:identifier="http://www.michaelteper.com:443/archive/2004/09/01/220.aspx"
         dc:title="San Francisco Bay Area police speed traps"
         trackback:ping="/services/trackbacks/220.aspx" 
      />
   </rdf:RDF>
