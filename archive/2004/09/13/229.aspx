...
<script type="text/javascript">
 ...
 var postTitle = "Top 10 Criteria Investors Want To See in a Business Plan";
 var postURL = "http://www.michaelteper.com:443/archive/2004/09/13/229.aspx";
...
<script type="text/javascript" src="http://www.cocomment.com/js/cocomment.js">
	...
	<body>
		<form name="Form1" method="post" action="229.aspx" id="Form1">
...
posts - 105, comments - 55, trackbacks - 1</div>
	<div id="switcher">
	    <a id="switchlink" href="229.aspx#" title="Click here to change the content width" style="display:none;"><span></span></a>
	</div>
</div>
...
<div class="previousNext">
	<a id="ctl06_PreviousNext_PrevLink" title="previous post" href="../02/225.aspx">&lt;&lt; Simple .Net screen ruler (awesome!)</a>
	...
	<a id="ctl06_PreviousNext_NextLink" title="next post" href="../14/230.aspx">Animal Cruelty &gt;&gt;</a>
</div>


<div class="entry">
	<h4><a id="ctl06_TitleUrl" title="Title of this entry." href="229.aspx">Top 10 Criteria Investors Want To See in a Business Plan</a></h4>
	<p>In the process of cleaning my desk, I came across this clipping from a November 2003 issue of Bio-ITWord: <a href="http://www.bio-itworld.com/archive/111403/bioshed_sidebar_3725.html">Top 10 Criteria Investors Want To See in a Business Plan</a>. Sure enough, there was a digital copy out on the web. Just in case they take it down, here they are:</p>
<p><font size="2"><font face="Verdana"><strong>1 Proof of concept.</strong> Demonstrate a tangible and viable product. Experimental betas should be field-tested or put through simulation. </font></font></p>
<p></p>
<p class="body"><b>2 Product diversification.</b> A software designer that commits resources to developing a broad portfolio of applications signals that biodefense is a core business, not just a pet project on the side, and increases funding potential. A combination of hardware and software with mission-specific technology covering diagnostics, mitigation, communication, and recovery flags the firm's versatility and potential profitability by servicing different buyer needs. </p>
<p class="body"><b>3 Product track record.</b> A developer might boast about its overall success in DNA mapping, highlighting examples of prior genomic work using its software. Successful civilian sales can be a good indicator of how revamped applied technology in the defense arena can perform. </p>
<p class="body"><b>4 Scientific talent.</b> A biodefense firm's brain trust should include talent with intense research, academic, engineering, medical, and product development experience. Investors will also look for those who have had careers in or connections with the military, inspiring confidence that managers know how the science can be practically applied to the mission at hand. </p>
<p class="body"><b>5 Knowledgeable managers.</b> While arguably a CEO's main job is business development and navigating politics, he or she should also be highly conversant technically. It wouldn't hurt to have a former medical doctor or lab scientist take the head honcho's seat. The client expects software developers be tuned in to biotechnology issues as much as they are with computer issues. </p>
<p class="body"><b>6 Good connections.</b> Skittish investment bankers will preferentially back firms that have secured previous biodefense funding from one of the federal agencies, venture funds, or grant programs. The rationale is that if the government — the leading client of these products — will back you, then a private investor should as well. </p>
<p class="body"><b>7 Cash is still king.</b> Show that you made efficient use of that cash flow without squandering large sums on overhead. </p>
<p class="body"><b>8 Team player.</b> Also valued are joint venture and consortium relationships with name-brand defense firms. If you successfully team up with a Northrop Grumman or a Computer Associates, that's a winning strategy. </p>
<p class="body"><b>9 The beat of your own drummer.</b> Venture investors like one-of-a-kind proprietary products. The ability for a company to own its niche increases the chance of success. </p>
<p class="body"><b>10 Efficiency.</b> Demonstrate that your operation can mass-produce and deliver large quantities on demand when and where the client wants it. </p>
<p align="right"><i>—Jason B. Lee </i></p>

		<p class="post">
			posted @ Monday, September 13, 2004 3:39 PM
		</p>
</div>
   ...
   <rdf:RDF 
      ...
      <rdf:Description
         rdf:about="http://www.michaelteper.com:443/archive/2004/09/13/229.aspx"
         dc:identifier="http://www.michaelteper.com:443/archive/2004/09/13/229.aspx"
         dc:title="Top 10 Criteria Investors Want To See in a Business Plan"
         trackback:ping="/services/trackbacks/229.aspx" 
      />
   </rdf:RDF>
