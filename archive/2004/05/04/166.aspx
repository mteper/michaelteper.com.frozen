...
<script type="text/javascript">
 ...
 var postTitle = "Filter out WinCE documentation from MSDN";
 var postURL = "http://www.michaelteper.com:443/archive/2004/05/04/166.aspx";
...
<script type="text/javascript" src="http://www.cocomment.com/js/cocomment.js">
	...
	<body>
		<form name="Form1" method="post" action="166.aspx" id="Form1">
...
posts - 105, comments - 55, trackbacks - 1</div>
	<div id="switcher">
	    <a id="switchlink" href="166.aspx#" title="Click here to change the content width" style="display:none;"><span></span></a>
	</div>
</div>
...
<div class="previousNext">
	<a id="ctl06_PreviousNext_PrevLink" title="previous post" href="../../04/29/165.aspx">&lt;&lt; Googe (Toolbar) does evil, customer blames Microsoft</a>
	...
	<a id="ctl06_PreviousNext_NextLink" title="next post" href="../../06/14/172.aspx">Missing VSS menus in VS.NET 2003 &gt;&gt;</a>
</div>


<div class="entry">
	<h4><a id="ctl06_TitleUrl" title="Title of this entry." href="166.aspx">Filter out WinCE documentation from MSDN</a></h4>
	There is a great <A href="http://blogs.msdn.com/saurabhjain/archive/2004/03/08/85821.aspx">tip and discussion</A> on <A href="http://blogs.msdn.com/saurabhjain">Saurabh's blog</A> on the subject on filtering out WinCE documentation from the MSDN search results. But why stop there, WinCE is not the only less used (useful?) topic set in MSDN that has a lot of overlap with other API. How about a way to filter out FoxPro docs?

		<p class="post">
			posted @ Tuesday, May 4, 2004 12:22 PM
		</p>
</div>
   ...
   <rdf:RDF 
      ...
      <rdf:Description
         rdf:about="http://www.michaelteper.com:443/archive/2004/05/04/166.aspx"
         dc:identifier="http://www.michaelteper.com:443/archive/2004/05/04/166.aspx"
         dc:title="Filter out WinCE documentation from MSDN"
         trackback:ping="/services/trackbacks/166.aspx" 
      />
   </rdf:RDF>
