...
<script type="text/javascript">
 ...
 var postTitle = "ASP.NET 2.0 MembershipProvider issues";
 var postURL = "http://www.michaelteper.com:443/archive/2004/07/12/186.aspx";
...
<script type="text/javascript" src="http://www.cocomment.com/js/cocomment.js">
	...
	<body>
		<form name="Form1" method="post" action="186.aspx" id="Form1">
...
posts - 105, comments - 55, trackbacks - 1</div>
	<div id="switcher">
	    <a id="switchlink" href="186.aspx#" title="Click here to change the content width" style="display:none;"><span></span></a>
	</div>
</div>
...
<div class="previousNext">
	<a id="ctl06_PreviousNext_PrevLink" title="previous post" href="../05/183.aspx">&lt;&lt; ASP.NET 2.0 takes away from the code-behind model</a>
	...
	<a id="ctl06_PreviousNext_NextLink" title="next post" href="../13/187.aspx">How to reverse engineer and debug MSI files &gt;&gt;</a>
</div>


<div class="entry">
	<h4><a id="ctl06_TitleUrl" title="Title of this entry." href="186.aspx">ASP.NET 2.0 MembershipProvider issues</a></h4>
	I <A href="http://michaelteper.com/archive/2004/06/24/177.aspx">blogged on this topic before</A>, but just ran into a <A href="http://blogs.tamtam.nl/paulb/PermaLink.aspx?guid=283de943-3fe2-4ea8-a7ba-2115320a9c6a">blog post by Paul van Brenk</A> with a different set of issues.

		<p class="post">
			posted @ Monday, July 12, 2004 9:57 AM
		</p>
</div>
   ...
   <rdf:RDF 
      ...
      <rdf:Description
         rdf:about="http://www.michaelteper.com:443/archive/2004/07/12/186.aspx"
         dc:identifier="http://www.michaelteper.com:443/archive/2004/07/12/186.aspx"
         dc:title="ASP.NET 2.0 MembershipProvider issues"
         trackback:ping="/services/trackbacks/186.aspx" 
      />
   </rdf:RDF>
