...
<script type="text/javascript">
 ...
 var postTitle = "Message patterns in SOA";
 var postURL = "http://www.michaelteper.com:443/archive/2004/07/26/190.aspx";
...
<script type="text/javascript" src="http://www.cocomment.com/js/cocomment.js">
	...
	<body>
		<form name="Form1" method="post" action="190.aspx" id="Form1">
...
posts - 105, comments - 55, trackbacks - 1</div>
	<div id="switcher">
	    <a id="switchlink" href="190.aspx#" title="Click here to change the content width" style="display:none;"><span></span></a>
	</div>
</div>
...
<div class="previousNext">
	<a id="ctl06_PreviousNext_PrevLink" title="previous post" href="../22/189.aspx">&lt;&lt; LookOut available for download from Microsoft</a>
	...
	<a id="ctl06_PreviousNext_NextLink" title="next post" href="../../08/04/192.aspx">Troubleshooting Windows Firewall in Microsoft Windows XP Service Pack 2 &gt;&gt;</a>
</div>


<div class="entry">
	<h4><a id="ctl06_TitleUrl" title="Title of this entry." href="190.aspx">Message patterns in SOA</a></h4>
	MSDN published&nbsp;a <A href="http://msdn.microsoft.com/architecture/journal/default.aspx?pull=/library/en-us/dnmaj/html/aj2mpsoarch.asp">great overview of message patterns</A> that one might encounter in the course of implementing a Service Oriented Architecture. The article also gives a quick overview of SOA and touches on the benefits of message rather than method centric approach.

		<p class="post">
			posted @ Monday, July 26, 2004 8:44 PM
		</p>
</div>
   ...
   <rdf:RDF 
      ...
      <rdf:Description
         rdf:about="http://www.michaelteper.com:443/archive/2004/07/26/190.aspx"
         dc:identifier="http://www.michaelteper.com:443/archive/2004/07/26/190.aspx"
         dc:title="Message patterns in SOA"
         trackback:ping="/services/trackbacks/190.aspx" 
      />
   </rdf:RDF>
