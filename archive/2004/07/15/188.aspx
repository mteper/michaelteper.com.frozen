...
<script type="text/javascript">
 ...
 var postTitle = "Visual Studio 2005 Express does not include Source Control integration.";
 var postURL = "http://www.michaelteper.com:443/archive/2004/07/15/188.aspx";
...
<script type="text/javascript" src="http://www.cocomment.com/js/cocomment.js">
	...
	<body>
		<form name="Form1" method="post" action="188.aspx" id="Form1">
...
posts - 105, comments - 55, trackbacks - 1</div>
	<div id="switcher">
	    <a id="switchlink" href="188.aspx#" title="Click here to change the content width" style="display:none;"><span></span></a>
	</div>
</div>
...
<div class="previousNext">
	<a id="ctl06_PreviousNext_PrevLink" title="previous post" href="../13/187.aspx">&lt;&lt; How to reverse engineer and debug MSI files</a>
	...
	<a id="ctl06_PreviousNext_NextLink" title="next post" href="../22/189.aspx">LookOut available for download from Microsoft &gt;&gt;</a>
</div>


<div class="entry">
	<h4><a id="ctl06_TitleUrl" title="Title of this entry." href="188.aspx">Visual Studio 2005 Express does not include Source Control integration.</a></h4>
	<P>Mike Gunderloy <A href="http://www.larkware.com/Articles/TheDailyGrind419.html">pointed</A> to the <A href="http://lab.msdn.microsoft.com/vs2005/productinfo/productline/default.aspx">Visual Studio 2005 Product Line Overview</A> page and commented that he doesn't understand why the Express line does not include source control support.</P>
<P>This was one of the things that jumped out at me as well. The Express line of products is intended for a hobbyist programmer and one could do no greater service than introduce a beginner to the concept of source control. Fine, don't include VSS, but at least throw in the option to support SCC integration!</P>
<P>IMO, SCC is the concept every beginning developer should be forced to learn. Thay may be too extreme a view, but not even giving a hint of SCC support is too extreme in the opposite direction!</P>

		<p class="post">
			posted @ Thursday, July 15, 2004 9:57 AM
		</p>
</div>
   ...
   <rdf:RDF 
      ...
      <rdf:Description
         rdf:about="http://www.michaelteper.com:443/archive/2004/07/15/188.aspx"
         dc:identifier="http://www.michaelteper.com:443/archive/2004/07/15/188.aspx"
         dc:title="Visual Studio 2005 Express does not include Source Control integration."
         trackback:ping="/services/trackbacks/188.aspx" 
      />
   </rdf:RDF>
