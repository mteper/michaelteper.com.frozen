...
<script type="text/javascript">
 ...
 var postTitle = "ASP.NET 2.0 takes away from the code-behind model";
 var postURL = "http://www.michaelteper.com:443/archive/2004/07/05/183.aspx";
...
<script type="text/javascript" src="http://www.cocomment.com/js/cocomment.js">
	...
	<body>
		<form name="Form1" method="post" action="183.aspx" id="Form1">
...
posts - 105, comments - 55, trackbacks - 1</div>
	<div id="switcher">
	    <a id="switchlink" href="183.aspx#" title="Click here to change the content width" style="display:none;"><span></span></a>
	</div>
</div>
...
<div class="previousNext">
	<a id="ctl06_PreviousNext_PrevLink" title="previous post" href="../../06/29/181.aspx">&lt;&lt; Walkthrough: Localizing Web Forms Pages</a>
...
<div class="entry">
   ...
   <rdf:RDF 
      ...
      <rdf:Description
         rdf:about="http://www.michaelteper.com:443/archive/2004/07/05/183.aspx"
         dc:identifier="http://www.michaelteper.com:443/archive/2004/07/05/183.aspx"
         dc:title="ASP.NET 2.0 takes away from the code-behind model"
         trackback:ping="/services/trackbacks/183.aspx" 
      />
   </rdf:RDF>
...
<div id="comments">
	...
	<p></p>
			...
			<div class="target comment">
				<h4>
					<a id="ctl08_CommentList_ctl00_EditCommentImgLink"></a><a title="permalink: re: ASP.NET 2.0 takes away from the code-behind model" href="183.aspx#233">#</a>&nbsp;<a name="233"></a>re: ASP.NET 2.0 takes away from the code-behind model
				</h4>
				<div class="info">Left by <a id="ctl08_CommentList_ctl00_NameLink" title="Sankar.B" target="_blank">Sankar.B</a> at 7/6/2004 8:22 PM</div>
				<div class="gravatar"><img id="ctl08_CommentList_ctl00_GravatarImg" src="../../../../images/services/IdenticonHandler.ashx@code=1661042168" alt="Gravatar" width="50" border="0" /></div>
				<div class="post">
					<div>
						Hi,<br><br>Yes ur right. The Initialise part and the webform designer generated code can be given in a seperate partial class as WebForm1.Designer.aspx.cs as given in the partial class WinForm1.Designer.cs which has all the VS.NET IDE designer generated code. And the EntryPoint.cs has a clear seperation of starting up the WinForm (Offcourse WebForm does'nt require an entrypoint.cs). So, itll be better a Designer.aspx.cs file for the WebForm's also. <br><br>And, as stated above, it is def. required that we need the functionality to build only the .cs files and deploy the ASPX, ASCS files as it is during deployment.<br><br>Also, again, as stated above, the need for including the namespaces in the cs file is required. Now, i feel im not working in a fully featured IDE. It looks like im working in FrontPage where everything is wrapped. We will forget what namespace to be included for at some point of time if we continue working in ASP.NET 2.0. One thing can be done. If i declare DataSet in my aspx.cs file, the IDE can include the Namespace System.Data in the using region automatically. If required, we can go and see if its included.<br><br>With Regards,<br>Sankar.B
					</div>
			...
			<div class="target comment">
				<h4>
					<a id="ctl08_CommentList_ctl01_EditCommentImgLink"></a><a title="permalink: re: ASP.NET 2.0 takes away from the code-behind model" href="183.aspx#245">#</a>&nbsp;<a name="245"></a>re: ASP.NET 2.0 takes away from the code-behind model
				</h4>
				<div class="info">Left by <a id="ctl08_CommentList_ctl01_NameLink" title="Willie T." target="_blank">Willie T.</a> at 8/13/2004 10:33 AM</div>
				<div class="gravatar"><img id="ctl08_CommentList_ctl01_GravatarImg" src="../../../../images/services/IdenticonHandler.ashx@code=414642248" alt="Gravatar" width="50" border="0" /></div>
				<div class="post">
					<div>
						Also, the data controls are great, but the inline sql commands are a bit strange.  What ever happend to code seperation with business and data access layers?  I'm just beginning to play around with this, but I'm sure hoping that I can just have a sealed (static too now) class that will allow me to bind data easily.<br /><br />One more thing, the master pages aren't what I thought they were going to be.  I think I'll take my own BasePage class any day.  What's with the DIV tag when you generate a new page.  header runat=server??<br /><br />Hmmm
					</div>
					<span class="adminLink">
			...
			<div class="target comment">
				<h4>
					<a id="ctl08_CommentList_ctl02_EditCommentImgLink"></a><a title="permalink: re: ASP.NET 2.0 takes away from the code-behind model" href="183.aspx#259">#</a>&nbsp;<a name="259"></a>re: ASP.NET 2.0 takes away from the code-behind model
				</h4>
				<div class="info">Left by <a id="ctl08_CommentList_ctl02_NameLink" title="http://www.atrevido.net/" href="http://www.atrevido.net/" target="_blank">Michael Giagnocavo</a> at 10/12/2004 5:52 AM</div>
				<div class="gravatar"><img id="ctl08_CommentList_ctl02_GravatarImg" src="../../../../images/services/IdenticonHandler.ashx@code=1793524773" alt="Gravatar" width="50" border="0" /></div>
				<div class="post">
					<div>
						YES! I agree with you exactly. I'm extremely annoyed with the new IDE crap in this area. I want a full DLL compiled and I want to be able to reference other code without using a bloody Code directory (what kinda crap is that?). The current model breaks a lot of things I do, and makes me re-org my code layout to fit under the Code directory, and that massively sucks.<br /><br />Perhaps we can get it working via a post-build or pre-build event if MS refuses to uncripple the product...?
					</div>
					<span class="adminLink">
