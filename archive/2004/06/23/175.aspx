...
<script type="text/javascript">
 ...
 var postTitle = "Wesner on the evolution of code editors";
 var postURL = "http://www.michaelteper.com:443/archive/2004/06/23/175.aspx";
...
<script type="text/javascript" src="http://www.cocomment.com/js/cocomment.js">
	...
	<body>
		<form name="Form1" method="post" action="175.aspx" id="Form1">
...
posts - 105, comments - 55, trackbacks - 1</div>
	<div id="switcher">
	    <a id="switchlink" href="175.aspx#" title="Click here to change the content width" style="display:none;"><span></span></a>
	</div>
</div>
...
<div class="previousNext">
	<a id="ctl06_PreviousNext_PrevLink" title="previous post" href="../14/174.aspx">&lt;&lt; .NET String.Replace() performance uncovered</a>
	...
	<a id="ctl06_PreviousNext_NextLink" title="next post" href="../24/176.aspx">Wesner on the evolution of code editors, part 2 &gt;&gt;</a>
</div>


<div class="entry">
	<h4><a id="ctl06_TitleUrl" title="Title of this entry." href="175.aspx">Wesner on the evolution of code editors</a></h4>
	<P><A href="http://wesnerm.blogs.com/net_undocumented/">Wesner Moise</A> wrote a <A href="http://wesnerm.blogs.com/net_undocumented/2004/06/whidbey_may_mis.html">post predicting that code editing capabilities in VS.NET 2005 will be behind the competition by the time it ships</A>. I agree with the premise but disagree with the analysis. Wesner&nbsp;asserts that the advent of macro-less, easily parsable languages like C#, VS.NET, and Java opens the door for IDE's to work with parse trees. He correctly points out the benefits&nbsp;of this&nbsp;that will come through IDE intelligence about code (rather than just text).&nbsp;But then he goes off the deep end predicting that developers will work with a graphical representation of this parse tree directly. I just don't see that happening. Ultimately, IDE's&nbsp;are all about productivity, and (though is has been tried many times before), no RAD tool yet has offered a compelling replacement for laying out arbitrary code logic better than terse text syntax. RAD is great for laying out UI, its great for devising schemas, its great for visual analysis and 50,000 ft views, but its just not productive for the actual development of program logic.</P>
<P>What I do see happening is that desktop memory and processing power has finally enabled the IDE to maintain and work with code parse trees even for sizeable projects. I think this is the key reason we are finally seeing companies like JetBrains, Microsoft, IBM, and others start to put true code intelligence into their editors. The reason I feel Microsoft is going to end up behind the ball with Whidbey (err, VS.NET 2005) is that it was late to the party to begin with and hasn't done enough to jump ahead. The refactoring support in Whidbey (at least that has been shown to public to date) is at the level the competition was at years ago. Today, I see <A href="http://www.jetbrains.com/resharper/index.html">JetBrains</A> putting more and more small but very powerful improvements into enhancing the actual process of writing code (think IntelliSence on steroids, it really streamlines &#8220;dull&#8221; typing); while others, like <A href="http://www.devexpress.com/?section=/products/NET/Coderush">DevExpress with CodeRush</A> take a more visual approach. In both cases, it is still all about the code expressed in a programming language and layed out by hand in a text file.</P>
   ...
   <rdf:RDF 
      ...
      <rdf:Description
         rdf:about="http://www.michaelteper.com:443/archive/2004/06/23/175.aspx"
         dc:identifier="http://www.michaelteper.com:443/archive/2004/06/23/175.aspx"
         dc:title="Wesner on the evolution of code editors"
         trackback:ping="/services/trackbacks/175.aspx" 
      />
   </rdf:RDF>
