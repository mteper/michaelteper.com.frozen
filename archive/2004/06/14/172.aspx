...
<script type="text/javascript">
 ...
 var postTitle = "Missing VSS menus in VS.NET 2003";
 var postURL = "http://www.michaelteper.com:443/archive/2004/06/14/172.aspx";
...
<script type="text/javascript" src="http://www.cocomment.com/js/cocomment.js">
	...
	<body>
		<form name="Form1" method="post" action="172.aspx" id="Form1">
...
posts - 105, comments - 55, trackbacks - 1</div>
	<div id="switcher">
	    <a id="switchlink" href="172.aspx#" title="Click here to change the content width" style="display:none;"><span></span></a>
	</div>
</div>
...
<div class="previousNext">
	<a id="ctl06_PreviousNext_PrevLink" title="previous post" href="../../05/04/166.aspx">&lt;&lt; Filter out WinCE documentation from MSDN</a>
	...
	<a id="ctl06_PreviousNext_NextLink" title="next post" href="173.aspx">Unexpected string performance in .Net 1.1 &gt;&gt;</a>
</div>


<div class="entry">
	<h4><a id="ctl06_TitleUrl" title="Title of this entry." href="172.aspx">Missing VSS menus in VS.NET 2003</a></h4>
	<P>I opened up VS.NET 2003 today and realized that the Source Control menus were nowhere in sight. So if that happens to you, quick tip: register the SSSCC.dll and everything will be OK again.</P>
<P>First, locate SSSCC.dll on your machine, typically located in the win32 folder of your Visual SourceSafe installation. Then open a command prompt in that folder and run the following command &#8220;regsvr32 ssscc.dll&#8221;. Restart VS.NET and all should be well.</P>
<P>Good luck!</P>
   ...
   <rdf:RDF 
      ...
      <rdf:Description
         rdf:about="http://www.michaelteper.com:443/archive/2004/06/14/172.aspx"
         dc:identifier="http://www.michaelteper.com:443/archive/2004/06/14/172.aspx"
         dc:title="Missing VSS menus in VS.NET 2003"
         trackback:ping="/services/trackbacks/172.aspx" 
      />
   </rdf:RDF>
