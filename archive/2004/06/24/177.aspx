...
<script type="text/javascript">
 ...
 var postTitle = "I hope Whidbey MembershipProvider API changes before release";
 var postURL = "http://www.michaelteper.com:443/archive/2004/06/24/177.aspx";
...
<script type="text/javascript" src="http://www.cocomment.com/js/cocomment.js">
	...
	<body>
		<form name="Form1" method="post" action="177.aspx" id="Form1">
...
posts - 105, comments - 55, trackbacks - 1</div>
	<div id="switcher">
	    <a id="switchlink" href="177.aspx#" title="Click here to change the content width" style="display:none;"><span></span></a>
	</div>
</div>
...
<div class="previousNext">
	<a id="ctl06_PreviousNext_PrevLink" title="previous post" href="176.aspx">&lt;&lt; Wesner on the evolution of code editors, part 2</a>
	...
	<a id="ctl06_PreviousNext_NextLink" title="next post" href="../25/178.aspx">VS.Net 2005 May CTP, adding assembly reference to Web project &gt;&gt;</a>
</div>


<div class="entry">
	<h4><a id="ctl06_TitleUrl" title="Title of this entry." href="177.aspx">I hope Whidbey MembershipProvider API changes before release</a></h4>
	<P>I started looking closer at the upcoming provider model in ASP.NET 2.0 and found some troubling patterns in current incarnation of the API (as of the May 2004 CTP). One example is MembershipProvider.ChangePassword method with the following signature:</P>
<P>public abstract bool ChangePassword(<BR>&nbsp;string name, <BR>&nbsp;string oldPassword, <BR>&nbsp;string newPassword<BR>);<BR></P>
<P>Can anyone spot a problem? I'll give you a hint, look at the return type. Now, without looking at the docs, can you tell me without a shadow of a doubt what that boolean value indicates? I didn't think so.</P>
<P>In this case, the API follows the old C convention of returning a boolean value to indicate whether the operation succeeded. This convention always felt incomplete to me, and it truly has no place in the world that has structured exception handling, and ESPECIALLY, for a method that should not, under normal circumstances, be a performance bottleneck.</P>
<P>In my opinion, the return type should be void and one should be able to safely assume that under normal conditions the operation will always succeed. Any failure to do so is an exception, and should be handled through the exception mechanism.</P>
   ...
   <rdf:RDF 
      ...
      <rdf:Description
         rdf:about="http://www.michaelteper.com:443/archive/2004/06/24/177.aspx"
         dc:identifier="http://www.michaelteper.com:443/archive/2004/06/24/177.aspx"
         dc:title="I hope Whidbey MembershipProvider API changes before release"
         trackback:ping="/services/trackbacks/177.aspx" 
      />
   </rdf:RDF>
...
<div id="comments">
	...
	<p></p>
			...
			<div class="target comment">
				<h4>
					<a id="ctl08_CommentList_ctl00_EditCommentImgLink"></a><a title="permalink: re: I hope Whidbey MembershipProvider API changes before release" href="177.aspx#235">#</a>&nbsp;<a name="235"></a>re: I hope Whidbey MembershipProvider API changes before release
				</h4>
				<div class="info">Left by <a id="ctl08_CommentList_ctl00_NameLink" title="http://weblogs.asp.net/rmclaws" href="http://weblogs.asp.net/rmclaws" target="_blank">Robert W. McLaws</a> at 8/6/2004 5:07 PM</div>
				<div class="gravatar"><img id="ctl08_CommentList_ctl00_GravatarImg" src="../../../../images/services/IdenticonHandler.ashx@code=308203162" alt="Gravatar" width="50" border="0" /></div>
				<div class="post">
					<div>
			...
			<div class="target comment">
				<h4>
					<a id="ctl08_CommentList_ctl01_EditCommentImgLink"></a><a title="permalink: re: I hope Whidbey MembershipProvider API changes before release" href="177.aspx#236">#</a>&nbsp;<a name="236"></a>re: I hope Whidbey MembershipProvider API changes before release
				</h4>
				<div class="info">Left by <a id="ctl08_CommentList_ctl01_NameLink" title="http://www.michaelteper.com/" href="http://www.michaelteper.com/" target="_blank">Michael Teper</a> at 8/6/2004 8:14 PM</div>
				...
				<div class="post">
					<div>
						I responded to Robert in a new blog entry here: <a target="_new" href="http://michaelteper.com/archive/2004/08/06/195.aspx">http://michaelteper.com/archive/2004/08/06/195.aspx</a>.
					</div>
					<span class="adminLink">
