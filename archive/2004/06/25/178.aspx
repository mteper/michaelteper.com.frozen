...
<script type="text/javascript">
 ...
 var postTitle = "VS.Net 2005 May CTP, adding assembly reference to Web project";
 var postURL = "http://www.michaelteper.com:443/archive/2004/06/25/178.aspx";
...
<script type="text/javascript" src="http://www.cocomment.com/js/cocomment.js">
	...
	<body>
		<form name="Form1" method="post" action="178.aspx" id="Form1">
...
posts - 105, comments - 55, trackbacks - 1</div>
	<div id="switcher">
	    <a id="switchlink" href="178.aspx#" title="Click here to change the content width" style="display:none;"><span></span></a>
	</div>
</div>
...
<div class="previousNext">
	<a id="ctl06_PreviousNext_PrevLink" title="previous post" href="../24/177.aspx">&lt;&lt; I hope Whidbey MembershipProvider API changes before release</a>
	...
	<a id="ctl06_PreviousNext_NextLink" title="next post" href="../26/179.aspx">VS.Net 2005 May CTP, Membership PasswordRecovery &gt;&gt;</a>
</div>


<div class="entry">
	<h4><a id="ctl06_TitleUrl" title="Title of this entry." href="178.aspx">VS.Net 2005 May CTP, adding assembly reference to Web project</a></h4>
	<P>I couldn't find a way to add an external&nbsp;project reference to my Whidbey web project, so I googled for answers. Instead, I found that <A href="http://weblogs.asp.net/mhawley/">Matt Hawley</A>, among others <A href="http://weblogs.asp.net/mhawley/archive/2004/03/29/101194.aspx">was having the same problem</A>. Well, Matt hasn't looked hard enough! :-)</P>
<P>The answer is right there in the Readme:</P>
<hr>
<P><STRONG>13.19. The Add Reference button in property pages dialog boxes does not work</STRONG><BR>&nbsp;</P>
<P>Steps to reproduce:</P>
<P>Start Visual Studio 2005. <BR>Create a new Web site.<BR>Right-click the Web project in Solution Explorer and click Property Pages on the shortcut menu.<BR>Click Add Reference.<BR>Nothing happens.</P>
<P>&nbsp;</P>
<P>To resolve this issue </P>
<P>&nbsp;</P>
<P>To add a reference to a managed assembly: Create a /Bin folder and add the assembly to /Bin by using the Add existing item shortcut menu To add a reference to an unmanaged COM component: Use TlbImp.exe to create an interop assembly and add that assembly to /Bin by using the steps above There currently is no workaround for adding a project reference.</P><hr>
<P>Enjoy!</P>
   ...
   <rdf:RDF 
      ...
      <rdf:Description
         rdf:about="http://www.michaelteper.com:443/archive/2004/06/25/178.aspx"
         dc:identifier="http://www.michaelteper.com:443/archive/2004/06/25/178.aspx"
         dc:title="VS.Net 2005 May CTP, adding assembly reference to Web project"
         trackback:ping="/services/trackbacks/178.aspx" 
      />
   </rdf:RDF>
