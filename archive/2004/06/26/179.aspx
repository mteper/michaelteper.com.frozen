...
<script type="text/javascript">
 ...
 var postTitle = "VS.Net 2005 May CTP, Membership PasswordRecovery";
 var postURL = "http://www.michaelteper.com:443/archive/2004/06/26/179.aspx";
...
<script type="text/javascript" src="http://www.cocomment.com/js/cocomment.js">
	...
	<body>
		<form name="Form1" method="post" action="179.aspx" id="Form1">
...
posts - 105, comments - 55, trackbacks - 1</div>
	<div id="switcher">
	    <a id="switchlink" href="179.aspx#" title="Click here to change the content width" style="display:none;"><span></span></a>
	</div>
</div>
...
<div class="previousNext">
	<a id="ctl06_PreviousNext_PrevLink" title="previous post" href="../25/178.aspx">&lt;&lt; VS.Net 2005 May CTP, adding assembly reference to Web project</a>
	...
	<a id="ctl06_PreviousNext_NextLink" title="next post" href="180.aspx">Once upon a time in Mexico, a quick review &gt;&gt;</a>
</div>


<div class="entry">
	<h4><a id="ctl06_TitleUrl" title="Title of this entry." href="179.aspx">VS.Net 2005 May CTP, Membership PasswordRecovery</a></h4>
	There is a bug in the May CTP bits of Whidbey that prevents the PasswordRecovery control from properly doing its magic. Specifically, it can't send an email because the SmtpMail class that this control relies on has some broken logic when it comes to reading the name/address of the SMTP server from the config file. The symptom is a COM error relating that the &#8220;SendUsing&#8221; configuration value is not defined. To fix this problem, make sure you set the value of the SMTP server in your code. (something like SmtpMail.SmtpServer = &#8220;localhost&#8221;;) Then, things will work like a charm. Of course, this tip is brought to you by the indispensable Lutz Roeder's Reflector.
		...
		<p class="post">
			posted @ Saturday, June 26, 2004 2:10 PM
		</p>
</div>
   ...
   <rdf:RDF 
      ...
      <rdf:Description
         rdf:about="http://www.michaelteper.com:443/archive/2004/06/26/179.aspx"
         dc:identifier="http://www.michaelteper.com:443/archive/2004/06/26/179.aspx"
         dc:title="VS.Net 2005 May CTP, Membership PasswordRecovery"
         trackback:ping="/services/trackbacks/179.aspx" 
      />
   </rdf:RDF>
