...
<script type="text/javascript">
 ...
 var postTitle = "Once upon a time in Mexico, a quick review";
 var postURL = "http://www.michaelteper.com:443/archive/2004/06/26/180.aspx";
...
<script type="text/javascript" src="http://www.cocomment.com/js/cocomment.js">
	...
	<body>
		<form name="Form1" method="post" action="180.aspx" id="Form1">
...
posts - 105, comments - 55, trackbacks - 1</div>
	<div id="switcher">
	    <a id="switchlink" href="180.aspx#" title="Click here to change the content width" style="display:none;"><span></span></a>
	</div>
</div>
...
<div class="previousNext">
	<a id="ctl06_PreviousNext_PrevLink" title="previous post" href="179.aspx">&lt;&lt; VS.Net 2005 May CTP, Membership PasswordRecovery</a>
	...
	<a id="ctl06_PreviousNext_NextLink" title="next post" href="../29/181.aspx">Walkthrough: Localizing Web Forms Pages &gt;&gt;</a>
</div>


<div class="entry">
	<h4><a id="ctl06_TitleUrl" title="Title of this entry." href="180.aspx">Once upon a time in Mexico, a quick review</a></h4>
	<P>The movie sucked.</P>
<P>The featurettes are really really interesting (and worth the rental), especially if you have any sort of interest in film-making or the application of technology to the creative process.</P>

		<p class="post">
			posted @ Saturday, June 26, 2004 8:51 PM
		</p>
</div>
   ...
   <rdf:RDF 
      ...
      <rdf:Description
         rdf:about="http://www.michaelteper.com:443/archive/2004/06/26/180.aspx"
         dc:identifier="http://www.michaelteper.com:443/archive/2004/06/26/180.aspx"
         dc:title="Once upon a time in Mexico, a quick review"
         trackback:ping="/services/trackbacks/180.aspx" 
      />
   </rdf:RDF>
...
<div id="comments">
	...
	<p></p>
			...
			<div class="target comment">
				<h4>
					<a id="ctl08_CommentList_ctl00_EditCommentImgLink"></a><a title="permalink: re: Once upon a time in Mexico, a quick review" href="180.aspx#232">#</a>&nbsp;<a name="232"></a>re: Once upon a time in Mexico, a quick review
				</h4>
				<div class="info">Left by <a id="ctl08_CommentList_ctl00_NameLink" title="http://www.4guysfromrolla.com/ScottMitchell.shtml" href="http://www.4guysfromrolla.com/ScottMitchell.shtml" target="_blank">Scott Mitchell</a> at 7/5/2004 5:07 PM</div>
				<div class="gravatar"><img id="ctl08_CommentList_ctl00_GravatarImg" src="../../../../images/services/IdenticonHandler.ashx@code=267365364" alt="Gravatar" width="50" border="0" /></div>
				<div class="post">
					<div>
						Three words: Worst. Movie. Ever.<br><br>(But the DVD featurettes were, as you pointed out, quite nice.  But hardly make up for the movie.)
					</div>
