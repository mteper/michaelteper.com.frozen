...
<script type="text/javascript">
 ...
 var postTitle = "Enable Remote Desktop remotely (via registry)";
 var postURL = "http://www.michaelteper.com:443/archive/2004/04/20/162.aspx";
...
<script type="text/javascript" src="http://www.cocomment.com/js/cocomment.js">
	...
	<body>
		<form name="Form1" method="post" action="162.aspx" id="Form1">
...
posts - 105, comments - 55, trackbacks - 1</div>
	<div id="switcher">
	    <a id="switchlink" href="162.aspx#" title="Click here to change the content width" style="display:none;"><span></span></a>
	</div>
</div>
...
<div class="previousNext">
	<a id="ctl06_PreviousNext_PrevLink" title="previous post" href="../10/161.aspx">&lt;&lt; Google mystery solved... or is it?</a>
	...
	<a id="ctl06_PreviousNext_NextLink" title="next post" href="../28/163.aspx">JavaScript OnUnload event broken in IE6 &gt;&gt;</a>
</div>


<div class="entry">
	<h4><a id="ctl06_TitleUrl" title="Title of this entry." href="162.aspx">Enable Remote Desktop remotely (via registry)</a></h4>
	A <A href="http://weblogs.asp.net/tonyschr/archive/2004/04/19/116245.aspx">great tip</A> from <A href="http://weblogs.asp.net/tonyschr/">Tony Schreiner</A> on how to remotely enable Remote Desktop. I wish I had known this earlier. Make sure to look in the comments for a tip on doing this straight through registry.

		<p class="post">
			posted @ Tuesday, April 20, 2004 7:03 AM
		</p>
</div>
   ...
   <rdf:RDF 
      ...
      <rdf:Description
         rdf:about="http://www.michaelteper.com:443/archive/2004/04/20/162.aspx"
         dc:identifier="http://www.michaelteper.com:443/archive/2004/04/20/162.aspx"
         dc:title="Enable Remote Desktop remotely (via registry)"
         trackback:ping="/services/trackbacks/162.aspx" 
      />
   </rdf:RDF>
...
<div id="comments">
	...
	<p></p>
			...
			<div class="target comment">
				<h4>
					<a id="ctl08_CommentList_ctl00_EditCommentImgLink"></a><a title="permalink: re: Enable Remote Desktop remotely (via registry)" href="162.aspx#13839">#</a>&nbsp;<a name="13839"></a>re: Enable Remote Desktop remotely (via registry)
				</h4>
				<div class="info">Left by <a id="ctl08_CommentList_ctl00_NameLink" title="Emad Sabar" target="_blank">Emad Sabar</a> at 7/5/2006 12:34 AM</div>
				<div class="gravatar"><img id="ctl08_CommentList_ctl00_GravatarImg" src="../../../../images/services/IdenticonHandler.ashx@code=-1950646251" alt="Gravatar" width="50" border="0" /></div>
				<div class="post">
					<div>
						Pls. visit this web page :  http://www.windowsdevcenter.com/lpt/a/4778<br /><br />Thanks
					</div>
