...
<script type="text/javascript">
 ...
 var postTitle = "Will Visual Studio .Net 2005 be delayed into 2006?";
 var postURL = "http://www.michaelteper.com:443/archive/2004/08/29/217.aspx";
...
<script type="text/javascript" src="http://www.cocomment.com/js/cocomment.js">
	...
	<body>
		<form name="Form1" method="post" action="217.aspx" id="Form1">
...
posts - 105, comments - 55, trackbacks - 1</div>
	<div id="switcher">
	    <a id="switchlink" href="217.aspx#" title="Click here to change the content width" style="display:none;"><span></span></a>
	</div>
</div>
...
<div class="previousNext">
	<a id="ctl06_PreviousNext_PrevLink" title="previous post" href="../17/212.aspx">&lt;&lt; Help Make Blogs More Visible!</a>
	...
	<a id="ctl06_PreviousNext_NextLink" title="next post" href="../../09/01/220.aspx">San Francisco Bay Area police speed traps &gt;&gt;</a>
</div>


<div class="entry">
	<h4><a id="ctl06_TitleUrl" title="Title of this entry." href="217.aspx">Will Visual Studio .Net 2005 be delayed into 2006?</a></h4>
	<p>Microsoft announced this week that it will pare down the planned feature set for Longhorn in order to be able to deliver the new OS in 2006. This caused big waves on the net and in the blogosphere with all sorts of speculation flying about. One take on the announcement places the Lognhorn release date in early 2006. If this is true (and that's a huge “if”), I am starting to wonder about the release schedule for Visual Studio .Net 2005.</p>
<p>For those who haven't been following the development of the next version of Visual Studio, we were first expecting the new dev siute (codename Whidbey) in late 2004. Then the schedule slipped into early 2005, and now, with one or two more betas expected in 2005, the speculation is that the release will happen in late 2005 (at least we'd hope so to justify the new product name). At the same time, Microsoft announced the follow-on release, codename Orcas, to show up in the Longhorn time frame.</p>
<p>Given that the Whidbey and Longhorn releases are now being targeted pretty close together, I am not sure there is any room left for Orcas. In fact, judging from past performance, I would venture a guess that the new OS will in fact debut in 2006. I would also think the VS.Net 2005 release will show up in or around the same time. I would also expect more fat (err, features) to be trimmed from Longhorn before we see it. Said fat, along with WinFS will probably resurface in a post-Longhorn release of the OS, circa, parhaps, 2008.</p>
<p>In other words, all we've witnessed this week is a reshuffling in marketing speak and product names. Its been widely reported that Microsoft will have a post-XP OS release prior to Longhorn delivery. It looks like Microsoft is still going forward with that plan by including a couple of ex-Longhorn features in that release (Indigo, the communications pipeline and Avalon, the graphics pipeline) and leaving off WinFS for what was formerly known as Longhorn target. The new, interim release inherits the “Longhorn“ moniker to pacify anyone complaining about slipping schedules.</p>
<p>Of course, this is all speculation, but it doesn't sound all that far-fetched to me.</p>

		<p class="post">
			posted @ Sunday, August 29, 2004 4:39 PM
		</p>
</div>
   ...
   <rdf:RDF 
      ...
      <rdf:Description
         rdf:about="http://www.michaelteper.com:443/archive/2004/08/29/217.aspx"
         dc:identifier="http://www.michaelteper.com:443/archive/2004/08/29/217.aspx"
         dc:title="Will Visual Studio .Net 2005 be delayed into 2006?"
         trackback:ping="/services/trackbacks/217.aspx" 
      />
   </rdf:RDF>
