...
<script type="text/javascript">
 ...
 var postTitle = "Microsoft Visual J# .NET Redistributable Package 1.1";
 var postURL = "http://www.michaelteper.com:443/archive/2004/08/08/200.aspx";
...
<script type="text/javascript" src="http://www.cocomment.com/js/cocomment.js">
	...
	<body>
		<form name="Form1" method="post" action="200.aspx" id="Form1">
...
posts - 105, comments - 55, trackbacks - 1</div>
	<div id="switcher">
	    <a id="switchlink" href="200.aspx#" title="Click here to change the content width" style="display:none;"><span></span></a>
	</div>
</div>
...
<div class="previousNext">
	<a id="ctl06_PreviousNext_PrevLink" title="previous post" href="../06/195.aspx">&lt;&lt; More on MembershipProvider API design</a>
	...
	<a id="ctl06_PreviousNext_NextLink" title="next post" href="../09/201.aspx">Even more on ASP.NET 2.0 Membership Provider API design and Exceptions &gt;&gt;</a>
</div>


<div class="entry">
	<h4><a id="ctl06_TitleUrl" title="Title of this entry." href="200.aspx">Microsoft Visual J# .NET Redistributable Package 1.1</a></h4>
	<p>My primary hard drive crashed and I found myself in an unenviable position of having to reinstall the OS and a crapload of applications. Spare me the backup sermon please, the data was backed up. I didn't feel it was worth doing full backups because I haven't found a good (inexpensive) way to take them off-line and because sad as it is, it is still fairly healthy to repave a Microsoft OS once in a while.</p>
<p>That's not the point of this post though. Reinstalling VS.Net 2003, I watched yet again as it installed the <strong>Microsoft Visual J# .NET Redistributable Package 1.1</strong> as a prerequisite of the product. It is so pointless, it painful. Can anyone out there, please!, explain why VS.Net 2003 (and 2005, by the looks of it) force this down my throat?!?</p>
<p>Thanks!</p>
<p><strong>UPDATE: </strong>See Aaron Stebner's (of Microsoft) comment to this post for an explanation. Thanks Aaron!!!</p>
   ...
   <rdf:RDF 
      ...
      <rdf:Description
         rdf:about="http://www.michaelteper.com:443/archive/2004/08/08/200.aspx"
         dc:identifier="http://www.michaelteper.com:443/archive/2004/08/08/200.aspx"
         dc:title="Microsoft Visual J# .NET Redistributable Package 1.1"
         trackback:ping="/services/trackbacks/200.aspx" 
      />
   </rdf:RDF>
...
<div id="comments">
	...
	<p></p>
			...
			<div class="target comment">
				<h4>
					<a id="ctl08_CommentList_ctl00_EditCommentImgLink"></a><a title="permalink: re: Microsoft Visual J# .NET Redistributable Package 1.1" href="200.aspx#246">#</a>&nbsp;<a name="246"></a>re: Microsoft Visual J# .NET Redistributable Package 1.1
				</h4>
				<div class="info">Left by <a id="ctl08_CommentList_ctl00_NameLink" title="http://blogs.msdn.com/astebner/" href="http://blogs.msdn.com/astebner/" target="_blank">Aaron Stebner</a> at 8/17/2004 11:26 PM</div>
				<div class="gravatar"><img id="ctl08_CommentList_ctl00_GravatarImg" src="../../../../images/services/IdenticonHandler.ashx@code=-1308879776" alt="Gravatar" width="50" border="0" /></div>
				<div class="post">
					<div>
						I can explain why you're seeing this behavior.  It is more the result of expediency than anything else.  When we were developing the setup for Visual Studio 2003, we didn't have any technology that would allow us to associate prerequisite components with features in the VS setup tree, and that release was a ~1 year point release, so we were basically restricted to the existing code base.  For VS 2005 (codename Whidbey) there will be new logic that allows us to associate prereq components with features in the VS tree, so the J# redist will only be installed when you choose to install J# language tools in VS setup.<br /><br />I do have to say that I don't understand why it is such a big deal to install the J# redist like this though - it is &lt; 3 megs in size and doesn't harm anything, plus you can uninstall it immediately after you finish VS setup.  I do agree it is pointless, but is it really painful?<br /><br />If you have any comments/questions, please send them on to aaronste@microsoft.com<br /><br />Thanks!<br />
					</div>
