...
<script type="text/javascript">
 ...
 var postTitle = "WindowsXP needs a new SKU";
 var postURL = "http://www.michaelteper.com:443/archive/2004/08/12/209.aspx";
...
<script type="text/javascript" src="http://www.cocomment.com/js/cocomment.js">
	...
	<body>
		<form name="Form1" method="post" action="209.aspx" id="Form1">
...
posts - 105, comments - 55, trackbacks - 1</div>
	<div id="switcher">
	    <a id="switchlink" href="209.aspx#" title="Click here to change the content width" style="display:none;"><span></span></a>
	</div>
</div>
...
<div class="previousNext">
	<a id="ctl06_PreviousNext_PrevLink" title="previous post" href="../11/208.aspx">&lt;&lt; WindowsXP sp2 slows down p2p apps</a>
	...
	<a id="ctl06_PreviousNext_NextLink" title="next post" href="../17/211.aspx">Example – An ASP.NET handler that returns a dynamically generated image  &gt;&gt;</a>
</div>


<div class="entry">
	<h4><a id="ctl06_TitleUrl" title="Title of this entry." href="209.aspx">WindowsXP needs a new SKU</a></h4>
	<p>I <a href="http://michaelteper.com/archive/2004/08/11/208.aspx">blogged yesterday</a> about the affect of the WindowsXP service pack 2 on filesharing applications. Apparently, there is more fallout as reported by <a href="http://silverstr.ufies.org/blog/archives/000666.html">Dana Epp</a>, <a href="http://www.interact-sw.co.uk/iangblog/2004/08/12/norawsockets">Ian Griffiths</a>, and <a href="http://www.leastprivilege.com/PermaLink.aspx?guid=724ffee9-fc25-4e12-855e-999e2f6ae6d7">Dominick Baier</a>. I understand that the motivation for these changes was to make the WindowsXP platform less appealing to viruses and hacker tools, and I also understand that the reason there aren't easy overrides for the new limits is so that the aforementioned malware can't just flip the functionality back on. But, at the same time, the changes are detrimental to some legitimate applications. Microsoft could just cede those users to OSX or Linux, but why not bring them back into the fold? We have WindowsXP Home and Professional, perhaps its time to bring out WindowsXP Power User edition? Concerned corporations can constrain installations through policy, unconcerned end users won't pay for it, and interested parties will get their functionality back. Redmond, are you listening?</p>
<p>And now, for something completely off-topic -- a well documented tryst between <a href="http://www.thenationaldebate.com/other/JohnFKerryAlien.wmv">John F. Kerry and Natasha Kinstridge</a> (<a href="http://www.thenationaldebate.com/blogger/archive/2004_08_01_TND-ARCHIVE.htm#109219673549891778">see commentary here</a>).</p>

		<p class="post">
			posted @ Thursday, August 12, 2004 11:16 AM
		</p>
</div>
   ...
   <rdf:RDF 
      ...
      <rdf:Description
         rdf:about="http://www.michaelteper.com:443/archive/2004/08/12/209.aspx"
         dc:identifier="http://www.michaelteper.com:443/archive/2004/08/12/209.aspx"
         dc:title="WindowsXP needs a new SKU"
         trackback:ping="/services/trackbacks/209.aspx" 
      />
   </rdf:RDF>
