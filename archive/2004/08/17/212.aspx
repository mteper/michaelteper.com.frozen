...
<script type="text/javascript">
 ...
 var postTitle = "Help Make Blogs More Visible!";
 var postURL = "http://www.michaelteper.com:443/archive/2004/08/17/212.aspx";
...
<script type="text/javascript" src="http://www.cocomment.com/js/cocomment.js">
	...
	<body>
		<form name="Form1" method="post" action="212.aspx" id="Form1">
...
posts - 105, comments - 55, trackbacks - 1</div>
	<div id="switcher">
	    <a id="switchlink" href="212.aspx#" title="Click here to change the content width" style="display:none;"><span></span></a>
	</div>
</div>
...
<div class="previousNext">
	<a id="ctl06_PreviousNext_PrevLink" title="previous post" href="211.aspx">&lt;&lt; Example – An ASP.NET handler that returns a dynamically generated image </a>
	...
	<a id="ctl06_PreviousNext_NextLink" title="next post" href="../29/217.aspx">Will Visual Studio .Net 2005 be delayed into 2006? &gt;&gt;</a>
</div>


<div class="entry">
	<h4><a id="ctl06_TitleUrl" title="Title of this entry." href="212.aspx">Help Make Blogs More Visible!</a></h4>
	<p></p>
<table>
<tbody>
<tr>
<td class="article">
<div class="blogbody">
<p>There are by some estimates more than a million weblogs. But most of them get no visibility in search engines. Only a few "A-List" blogs get into the top search engine results for a given topic, while the majority of blogs just don't get noticed. The reason is that the smaller blogs don't have enough links pointing to them. But this posting could solve that. Let's help the smaller blogs get more visibility!</p>
<p>This posting is <a class="blines3" title="Link outside of this blog" href="http://novaspivack.typepad.com/nova_spivacks_weblog/2004/08/what_is_a_gomem.html" target="_blank"><font color="#0033cc">GoMeme 4.0</font></a>. It is part of an experiment to see if we can create a blog posting that helps 1000's of blogs get higher rankings in Google. So far we have tried 3 earlier variations. Our first test, <a class="blines3" title="Link outside of this blog" href="http://novaspivack.typepad.com/nova_spivacks_weblog/2004/08/a_sonar_ping_of.html" target="_blank"><font color="#0033cc">GoMeme 1.0</font></a>, spread to nearly 740 blogs in 2.5 days. This new version 4.0 is shorter, simpler, and fits more easily into your blog. </p>
<p>Why are we doing this? We want to help thousands of blogs get more visibility in Google and other search engines. How does it work? Just follow the instructions below to re-post this meme in your blog and add your URL to the end of the Path List below. As the meme spreads onwards from your blog, so will your URL. Later, when your blog is indexed by search engines, they will see the links pointing to your blog from all the downstream blogs that got this via you, which will cause them to rank your blog higher in search results. Everyone in the Path List below benefits in a similar way as this meme spreads. Try it! </p>
<p><b>Instructions:</b> Just copy this entire post and paste it into your blog. Then add your URL to the end of the path list below, and pass it on! (Make sure you add your URLs as live links or HTML code to the Path List below.)</p>
<p><b><u>Path List</u></b><br />1. <a class="blines3" title="Link outside of this blog" href="http://www.mindingtheplanet.net/" target="_blank"><font color="#0033cc">Minding the Planet</font></a><br />2. <a class="blines3" title="Link outside of this blog" href="http://www.hutteman.com/weblog/" target="_blank"><font color="#0033cc">Luke Hutteman's public virtual MemoryStream</font></a><br />3. <a class="blines3" title="Link outside of this blog" href="http://blogs.msdn.com/jaybaz_MS" target="_blank">JayBaz_MS blog</a><br />4. <a href="http://www.MichaelTeper.com">Michael Teper blog</a><br />5. (your URL goes here! But first, please copy this line and move it down to the next line for the next person).</p>
<p><br />(NOTE: Be sure you paste live links for the Path List or use HTML code.)</p>
<p><strong>OK, so the above is the direct copy/paste of this meme. I wasn't sure I wanted to participate in it, but in the end decided to just just go ahead and give it a try. I am convinced, however, that it will do absolutely nothing for the popularity of this blog. See, the major flaw in the design is that someone has to read your blog in order to propagate the meme. In my case, my blog has very limited readership, and those hits that do come in are mostly directed to specific posts (either from other blogs or google). So, the likelyhood of anyone actually seeing this post is pretty low.</strong></p>
<p><strong>The other reason I was hesitant about participating is that this meme feels too much like a chain letter. There is little purpose to it beyond than making me feel better for passing it on and getting new viewers. I am giving it a shot as an experiment, but I doubt I will try this again in the future even if it brings in traffic against my prediction above.</strong></p></div></td></tr></tbody></table>

		<p class="post">
			posted @ Tuesday, August 17, 2004 3:27 PM
		</p>
</div>
   ...
   <rdf:RDF 
      ...
      <rdf:Description
         rdf:about="http://www.michaelteper.com:443/archive/2004/08/17/212.aspx"
         dc:identifier="http://www.michaelteper.com:443/archive/2004/08/17/212.aspx"
         dc:title="Help Make Blogs More Visible!"
         trackback:ping="/services/trackbacks/212.aspx" 
      />
   </rdf:RDF>
...
<div id="comments">
	...
	<p></p>
			...
			<div class="target comment">
				<h4>
					<a id="ctl08_CommentList_ctl00_EditCommentImgLink"></a><a title="permalink: My take on the meme" href="212.aspx#247">#</a>&nbsp;<a name="247"></a>My take on the meme
				</h4>
				<div class="info">Left by <a id="ctl08_CommentList_ctl00_NameLink" title="http://blogs.msdn.com/jaybaz_ms/archive/2004/08/17/216024.aspx" href="http://blogs.msdn.com/jaybaz_ms/archive/2004/08/17/216024.aspx" target="_blank">Pingback/TrackBack</a> at 8/18/2004 12:16 PM</div>
				<div class="gravatar"><img id="ctl08_CommentList_ctl00_GravatarImg" src="../../../../images/services/IdenticonHandler.ashx@code=1228234090" alt="Gravatar" width="50" border="0" /></div>
				<div class="post">
					<div>
						My take on the meme
					</div>
			...
			<div class="target comment">
				<h4>
					<a id="ctl08_CommentList_ctl01_EditCommentImgLink"></a><a title="permalink: re: Help Make Blogs More Visible!" href="212.aspx#248">#</a>&nbsp;<a name="248"></a>re: Help Make Blogs More Visible!
				</h4>
				<div class="info">Left by <a id="ctl08_CommentList_ctl01_NameLink" title="http://www.codinghorror.com/blog/" href="http://www.codinghorror.com/blog/" target="_blank">Jeff Atwood</a> at 8/24/2004 7:26 AM</div>
				...
				<div class="post">
					<div>
						Yeah, this has that nasty chain letter smell all over it.<br /><br />Better to read other blogs and post relevant comments in them, which links your URL to them.. kind of like what the spammers are doing, but except without the.. spam :)<br /><br />You know if spammers are doing it, it must work, because they only get paid for things that work. And I don't see spammers using chain letters..
					</div>
					<span class="adminLink">
			...
			<div class="target comment">
				<h4>
					<a id="ctl08_CommentList_ctl02_EditCommentImgLink"></a><a title="permalink: re: Help Make Blogs More Visible!" href="212.aspx#249">#</a>&nbsp;<a name="249"></a>re: Help Make Blogs More Visible!
				</h4>
				<div class="info">Left by <a id="ctl08_CommentList_ctl02_NameLink" title="http://www.codinghorror.com/blog/" href="http://www.codinghorror.com/blog/" target="_blank">Jeff Atwood</a> at 8/29/2004 11:19 AM</div>
				<div class="gravatar"><img id="ctl08_CommentList_ctl02_GravatarImg" src="../../../../images/services/IdenticonHandler.ashx@code=1119412571" alt="Gravatar" width="50" border="0" /></div>
				<div class="post">
					<div>
						I demand new blog content.
					</div>
					<span class="adminLink">
			...
			<div class="target comment">
				<h4>
					<a id="ctl08_CommentList_ctl03_EditCommentImgLink"></a><a title="permalink: re: Help Make Blogs More Visible!" href="212.aspx#265">#</a>&nbsp;<a name="265"></a>re: Help Make Blogs More Visible!
				</h4>
				<div class="info">Left by <a id="ctl08_CommentList_ctl03_NameLink" title="http://www.dirq.net/" href="http://www.dirq.net/" target="_blank">Dirk</a> at 1/6/2005 1:29 PM</div>
				<div class="gravatar"><img id="ctl08_CommentList_ctl03_GravatarImg" src="../../../../images/services/IdenticonHandler.ashx@code=-778494513" alt="Gravatar" width="50" border="0" /></div>
				<div class="post">
					<div>
						I saw it.  Just letting you know.
					</div>
					<span class="adminLink">
