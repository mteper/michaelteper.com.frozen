...
<script type="text/javascript">
 ...
 var postTitle = "Example – An ASP.NET handler that returns a dynamically generated image ";
 var postURL = "http://www.michaelteper.com:443/archive/2004/08/17/211.aspx";
...
<script type="text/javascript" src="http://www.cocomment.com/js/cocomment.js">
	...
	<body>
		<form name="Form1" method="post" action="211.aspx" id="Form1">
...
posts - 105, comments - 55, trackbacks - 1</div>
	<div id="switcher">
	    <a id="switchlink" href="211.aspx#" title="Click here to change the content width" style="display:none;"><span></span></a>
	</div>
</div>
...
<div class="previousNext">
	<a id="ctl06_PreviousNext_PrevLink" title="previous post" href="../12/209.aspx">&lt;&lt; WindowsXP needs a new SKU</a>
	...
	<a id="ctl06_PreviousNext_NextLink" title="next post" href="212.aspx">Help Make Blogs More Visible! &gt;&gt;</a>
</div>


<div class="entry">
	<h4><a id="ctl06_TitleUrl" title="Title of this entry." href="211.aspx">Example – An ASP.NET handler that returns a dynamically generated image </a></h4>
	<p>This is a verbatim excerpt from a Microsoft employee post on changes in ASP.NET 2.0 from Beta 1 to Beta 2:</p>
<p> </p>
<pre>&lt;%@ webhandler="" language="C#" class="ImageHandler" %=""&gt;
<br />
using System;
...
<br />public class ImageHandler : IHttpHandler {
<br />
...
<br />
 ...
 stream.Close();
 im.Dispose();
 imageBytes = stream.GetBuffer();<br />
...
<br /><br />
Thanks, <br /><br /><br /><br />Shanku Niyogi <br />Group Program Manager <br />Web Platform and Tools Team
</pre>
   ...
   <rdf:RDF 
      ...
      <rdf:Description
         rdf:about="http://www.michaelteper.com:443/archive/2004/08/17/211.aspx"
         dc:identifier="http://www.michaelteper.com:443/archive/2004/08/17/211.aspx"
         dc:title="Example – An ASP.NET handler that returns a dynamically generated image "
         trackback:ping="/services/trackbacks/211.aspx" 
      />
   </rdf:RDF>
