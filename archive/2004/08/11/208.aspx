...
<script type="text/javascript">
 ...
 var postTitle = "WindowsXP sp2 slows down p2p apps";
 var postURL = "http://www.michaelteper.com:443/archive/2004/08/11/208.aspx";
...
<script type="text/javascript" src="http://www.cocomment.com/js/cocomment.js">
	...
	<body>
		<form name="Form1" method="post" action="208.aspx" id="Form1">
...
posts - 105, comments - 55, trackbacks - 1</div>
	<div id="switcher">
	    <a id="switchlink" href="208.aspx#" title="Click here to change the content width" style="display:none;"><span></span></a>
	</div>
</div>
...
<div class="previousNext">
	<a id="ctl06_PreviousNext_PrevLink" title="previous post" href="204.aspx">&lt;&lt; Why is Indian music only available in RealAudio format?</a>
	...
	<a id="ctl06_PreviousNext_NextLink" title="next post" href="../12/209.aspx">WindowsXP needs a new SKU &gt;&gt;</a>
</div>


<div class="entry">
	<h4><a id="ctl06_TitleUrl" title="Title of this entry." href="208.aspx">WindowsXP sp2 slows down p2p apps</a></h4>
	<p>One of the security improvements in WindowsXP sp2 is a limit placed on the number of simultaneous incomplete outbound TCP connection attempts. This limit happens to be 10 connection per second, which just happens to adversely affect a number of p2p applications. To find out whether you are affected by this, check your System Event Log for Tcpip warnings with the event number 4226.</p>
<p>Its won't be a surprise to anyone that the community came up with a “fix”, a patch actually, that changes some bits in the tcpip.sys file. This is not something I would condone, so I won't link to it. My question is, does anyone know of a non-invasive way to override this limit? (perhaps through registry?). Could someone comment on the appropriate way for a p2p application to get around this new limit?</p>
<p>Here's the relevant excerpt from a <a href="http://www.microsoft.com/technet/prodtechnol/winxppro/maintain/sp2netwk.mspx#XSLTsection127121120120">TechNet document on sp2 changes</a>:</p>
<h4>Limited number of simultaneous incomplete outbound TCP connection attempts</h4>
<p><b><i>Detailed description</i></b></p>
<p>The TCP/IP stack now limits the number of simultaneous incomplete outbound TCP connection attempts. After the limit has been reached, subsequent connection attempts are put in a queue and will be resolved at a fixed rate. Under normal operation, when applications are connecting to available hosts at valid IP addresses, no connection rate-limiting will occur. When it does occur, a new event, with ID 4226, appears in the system’s event log.</p>
<p><b><i>Why is this change important? What threats does it help mitigate?</i></b></p>
<p>This change helps to limit the speed at which malicious programs, such as viruses and worms, spread to uninfected computers. Malicious programs often attempt to reach uninfected computers by opening simultaneous connections to random IP addresses. Most of these random addresses result in a failed connection, so a burst of such activity on a computer is a signal that it may have been infected by a malicious program.</p>
<p><b><i>What works differently?</i></b></p>
<p>This change may cause certain security tools, such as port scanners, to run more slowly.</p>
<p><b><i>How do I resolve these issues?</i></b></p>
<p>Stop the application that is responsible for the failing connection attempts.</p>
   ...
   <rdf:RDF 
      ...
      <rdf:Description
         rdf:about="http://www.michaelteper.com:443/archive/2004/08/11/208.aspx"
         dc:identifier="http://www.michaelteper.com:443/archive/2004/08/11/208.aspx"
         dc:title="WindowsXP sp2 slows down p2p apps"
         trackback:ping="/services/trackbacks/208.aspx" 
      />
   </rdf:RDF>
