...
<script type="text/javascript">
 ...
 var postTitle = "Why is Indian music only available in RealAudio format?";
 var postURL = "http://www.michaelteper.com:443/archive/2004/08/11/204.aspx";
...
<script type="text/javascript" src="http://www.cocomment.com/js/cocomment.js">
	...
	<body>
		<form name="Form1" method="post" action="204.aspx" id="Form1">
...
posts - 105, comments - 55, trackbacks - 1</div>
	<div id="switcher">
	    <a id="switchlink" href="204.aspx#" title="Click here to change the content width" style="display:none;"><span></span></a>
	</div>
</div>
...
<div class="previousNext">
	<a id="ctl06_PreviousNext_PrevLink" title="previous post" href="../09/201.aspx">&lt;&lt; Even more on ASP.NET 2.0 Membership Provider API design and Exceptions</a>
	...
	<a id="ctl06_PreviousNext_NextLink" title="next post" href="208.aspx">WindowsXP sp2 slows down p2p apps &gt;&gt;</a>
</div>


<div class="entry">
	<h4><a id="ctl06_TitleUrl" title="Title of this entry." href="204.aspx">Why is Indian music only available in RealAudio format?</a></h4>
	<p><a href="http://tresspasser.deviantart.com/">My sister</a> emailed me about a song she liked that was recommended by her Tamil friend. Apparently this is a tune for a popular Bollywood movie and Google revealed a number of web sites that would let me play it. Unfortunately, almost all of them offered just one format: RealAudio. Does anyone know why it is so popular with this audience? Personally, I refuse to install another Real product. Their installations are extremely invasive (all sorts of crap is installed without asking).</p>
<p>In any case, here's a WindowsMedia version for your non-discriminating music tastes: <a href="mms://winmedia.musicindiaonline.com/RayoH7IVPNk3FfDhMzLq2mOe8/wm/film/tam/Moviewise/K/KaakhaKaakha/Thoodhu.wma">Thoodhu Varuma, from the movie Kaakha Kaahka</a>.</p>

		<p class="post">
			posted @ Wednesday, August 11, 2004 9:33 AM
		</p>
</div>
   ...
   <rdf:RDF 
      ...
      <rdf:Description
         rdf:about="http://www.michaelteper.com:443/archive/2004/08/11/204.aspx"
         dc:identifier="http://www.michaelteper.com:443/archive/2004/08/11/204.aspx"
         dc:title="Why is Indian music only available in RealAudio format?"
         trackback:ping="/services/trackbacks/204.aspx" 
      />
   </rdf:RDF>
