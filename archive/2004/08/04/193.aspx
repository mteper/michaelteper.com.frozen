...
<script type="text/javascript">
 ...
 var postTitle = "Fun with Iterators";
 var postURL = "http://www.michaelteper.com:443/archive/2004/08/04/193.aspx";
...
<script type="text/javascript" src="http://www.cocomment.com/js/cocomment.js">
	...
	<body>
		<form name="Form1" method="post" action="193.aspx" id="Form1">
...
posts - 105, comments - 55, trackbacks - 1</div>
	<div id="switcher">
	    <a id="switchlink" href="193.aspx#" title="Click here to change the content width" style="display:none;"><span></span></a>
	</div>
</div>
...
<div class="previousNext">
	<a id="ctl06_PreviousNext_PrevLink" title="previous post" href="192.aspx">&lt;&lt; Troubleshooting Windows Firewall in Microsoft Windows XP Service Pack 2</a>
	...
	<a id="ctl06_PreviousNext_NextLink" title="next post" href="../06/195.aspx">More on MembershipProvider API design &gt;&gt;</a>
</div>


<div class="entry">
	<h4><a id="ctl06_TitleUrl" title="Title of this entry." href="193.aspx">Fun with Iterators</a></h4>
	<P>Wesner digs into iterators in his <A href="http://wesnerm.blogs.com/net_undocumented/2004/08/iterators_not_j.html">new blog post</A>. Its fascinating stuff and a lot to chew on. Its not clear to me though, in what way is his iterator-based chess game example better than code like the bit below?</P>
<P>public class Game<BR>{<BR>&nbsp;&nbsp; public static void Main()<BR>&nbsp;&nbsp; {<BR>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; bool gameOver&nbsp;= false;<BR>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; while (! gameOver)<BR>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; {<BR>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; gameOver = DoWhiteMove();<BR>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; if (! gameOver) gameOver = DoBlackMove();<BR>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; }<BR>&nbsp;&nbsp;&nbsp;&nbsp; }<BR>}</P>
<P>(sorry about lack of proper formatting).</P>
   ...
   <rdf:RDF 
      ...
      <rdf:Description
         rdf:about="http://www.michaelteper.com:443/archive/2004/08/04/193.aspx"
         dc:identifier="http://www.michaelteper.com:443/archive/2004/08/04/193.aspx"
         dc:title="Fun with Iterators"
         trackback:ping="/services/trackbacks/193.aspx" 
      />
   </rdf:RDF>
