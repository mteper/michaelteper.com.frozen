...
<script type="text/javascript">
 ...
 var postTitle = "DevDays 2004: attendee demographics.";
 var postURL = "http://www.michaelteper.com:443/archive/2004/03/10/154.aspx";
...
<script type="text/javascript" src="http://www.cocomment.com/js/cocomment.js">
	...
	<body>
		<form name="Form1" method="post" action="154.aspx" id="Form1">
...
posts - 105, comments - 55, trackbacks - 1</div>
	<div id="switcher">
	    <a id="switchlink" href="154.aspx#" title="Click here to change the content width" style="display:none;"><span></span></a>
	</div>
</div>
...
<div class="previousNext">
	<a id="ctl06_PreviousNext_PrevLink" title="previous post" href="https://www.michaelteper.com/archive/2004/03/10/153.aspx">&lt;&lt; DevDays 2004 San Francisco</a>
	...
	<a id="ctl06_PreviousNext_NextLink" title="next post" href="../11/155.aspx">Print publications screwing authors? &gt;&gt;</a>
</div>


<div class="entry">
	<h4><a id="ctl06_TitleUrl" title="Title of this entry." href="154.aspx">DevDays 2004: attendee demographics.</a></h4>
	<P>One more comment on DevDays: is it just me or are developers getting older? Looking around, it appeared to me like the average age of attendees was pushing high thirties. Made me feel decidedly young. Is it that there is no fresh blood in Valley? Was this event marketed only&nbsp;to the &#8220;senior&#8221; people? Should I remove the quotes?</P>
<P>Or have all the younger devs defected to the <A href="http://www.opensource.org/">OSS</A> side?</P>
<P>On the other hand, there was much comfort (yes, I am being sarcastic) in there being only 2.35 women in the audience. It looks like on that front things haven't changed at all. Unfortunately. A quick anecdote: just a couple of weeks ago I was at client meeting where my counterpart, the&nbsp;head of R&amp;D,&nbsp;was a woman. I caught myself noting how impressive that was. Not because I am a bigot, but because she was the first one I've ever encountered in that position.</P>

		<p class="post">
			posted @ Wednesday, March 10, 2004 7:58 PM
		</p>
</div>
   ...
   <rdf:RDF 
      ...
      <rdf:Description
         rdf:about="http://www.michaelteper.com:443/archive/2004/03/10/154.aspx"
         dc:identifier="http://www.michaelteper.com:443/archive/2004/03/10/154.aspx"
         dc:title="DevDays 2004: attendee demographics."
         trackback:ping="/services/trackbacks/154.aspx" 
      />
   </rdf:RDF>
