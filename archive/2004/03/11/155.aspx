...
<script type="text/javascript">
 ...
 var postTitle = "Print publications screwing authors?";
 var postURL = "http://www.michaelteper.com:443/archive/2004/03/11/155.aspx";
...
<script type="text/javascript" src="http://www.cocomment.com/js/cocomment.js">
	...
	<body>
		<form name="Form1" method="post" action="155.aspx" id="Form1">
...
posts - 105, comments - 55, trackbacks - 1</div>
	<div id="switcher">
	    <a id="switchlink" href="155.aspx#" title="Click here to change the content width" style="display:none;"><span></span></a>
	</div>
</div>
...
<div class="previousNext">
	<a id="ctl06_PreviousNext_PrevLink" title="previous post" href="../10/154.aspx">&lt;&lt; DevDays 2004: attendee demographics.</a>
	...
	<a id="ctl06_PreviousNext_NextLink" title="next post" href="../../04/10/160.aspx">Another Google Mystery &gt;&gt;</a>
</div>


<div class="entry">
	<h4><a id="ctl06_TitleUrl" title="Title of this entry." href="155.aspx">Print publications screwing authors?</a></h4>
	<P>I just read <A href="http://www.larkware.com/Articles/WhyINoLongerWriteforFawce.html">Mike Gunderloy's post</A> on Fawcette screwing him out of his payment. Is this common in the print industry? If so, I can't imagine why anyone would write at all. Take them to small claims!</P>
<P>This story certainly makes me appreciate my <A href="http://www.angrycoder.com/article.aspx?cid=5&amp;y=2003&amp;m=4&amp;d=11">writing relationship</A> with <A href="http://www.angrycoder.com/">Jonathan Goodyear</A> (the angryCoder) than much more. He paid per agreement and on time! Perhaps it is the sign of the future for on-line vs. off-line?</P>

		<p class="post">
			posted @ Thursday, March 11, 2004 6:53 AM
		</p>
</div>
   ...
   <rdf:RDF 
      ...
      <rdf:Description
         rdf:about="http://www.michaelteper.com:443/archive/2004/03/11/155.aspx"
         dc:identifier="http://www.michaelteper.com:443/archive/2004/03/11/155.aspx"
         dc:title="Print publications screwing authors?"
         trackback:ping="/services/trackbacks/155.aspx" 
      />
   </rdf:RDF>
...
<div id="comments">
	...
	<p></p>
			...
			<div class="target comment">
				<h4>
					<a id="ctl08_CommentList_ctl00_EditCommentImgLink"></a><a title="permalink: re: Print publications screwing authors?" href="155.aspx#223">#</a>&nbsp;<a name="223"></a>re: Print publications screwing authors?
				</h4>
				<div class="info">Left by <a id="ctl08_CommentList_ctl00_NameLink" title="http://www.larkware.com/" href="http://www.larkware.com/" target="_blank">Mike Gunderloy</a> at 3/11/2004 11:26 AM</div>
				<div class="gravatar"><img id="ctl08_CommentList_ctl00_GravatarImg" src="../../../../images/services/IdenticonHandler.ashx@code=1183562628" alt="Gravatar" width="50" border="0" /></div>
				<div class="post">
					<div>
						No, fortunately, Fawcette's behavior is not common in the print industry. I've worked with many print publications over the years, and never been treated this way by any other.
					</div>
			...
			<div class="target comment">
				<h4>
					<a id="ctl08_CommentList_ctl01_EditCommentImgLink"></a><a title="permalink: re: Print publications screwing authors?" href="155.aspx#224">#</a>&nbsp;<a name="224"></a>re: Print publications screwing authors?
				</h4>
				<div class="info">Left by <a id="ctl08_CommentList_ctl01_NameLink" title="http://weblogs.asp.net/jamauss" href="http://weblogs.asp.net/jamauss" target="_blank">Jason Mauss</a> at 3/11/2004 11:58 AM</div>
				<div class="gravatar"><img id="ctl08_CommentList_ctl01_GravatarImg" src="../../../../images/services/IdenticonHandler.ashx@code=1076791670" alt="Gravatar" width="50" border="0" /></div>
				<div class="post">
					<div>
						Michael - which article(s) on angryCoder is yours? I've written several for him too - I think the next one he puts up will be from me. Just curious.
					</div>
					<span class="adminLink">
			...
			<div class="target comment">
				<h4>
					<a id="ctl08_CommentList_ctl02_EditCommentImgLink"></a><a title="permalink: re: Print publications screwing authors?" href="155.aspx#225">#</a>&nbsp;<a name="225"></a>re: Print publications screwing authors?
				</h4>
				<div class="info">Left by <a id="ctl08_CommentList_ctl02_NameLink" title="http://weblogs.asp.net/jamauss" href="http://weblogs.asp.net/jamauss" target="_blank">Jason Mauss</a> at 3/11/2004 12:08 PM</div>
				<div class="gravatar"><img id="ctl08_CommentList_ctl02_GravatarImg" src="../../../../images/services/IdenticonHandler.ashx@code=1076791670" alt="Gravatar" width="50" border="0" /></div>
				<div class="post">
					<div>
						D'oh, nevermind - saw the link in your post.
					</div>
					<span class="adminLink">
			...
			<div class="target comment">
				<h4>
					<a id="ctl08_CommentList_ctl03_EditCommentImgLink"></a><a title="permalink: re: Print publications screwing authors?" href="155.aspx#226">#</a>&nbsp;<a name="226"></a>re: Print publications screwing authors?
				</h4>
				<div class="info">Left by <a id="ctl08_CommentList_ctl03_NameLink" title="http://weblogs.asp.net/dbrowning" href="http://weblogs.asp.net/dbrowning" target="_blank">Don</a> at 3/11/2004 4:47 PM</div>
				<div class="gravatar"><img id="ctl08_CommentList_ctl03_GravatarImg" src="../../../../images/services/IdenticonHandler.ashx@code=391160994" alt="Gravatar" width="50" border="0" /></div>
				<div class="post">
					<div>
						They owe  me money also!<br><br><a target="_new" href="http://weblogs.asp.net/dbrowning/archive/2004/03/11/88343.aspx">http://weblogs.asp.net/dbrowning/archive/2004/03/11/88343.aspx</a><br><br>
					</div>
					<span class="adminLink">
