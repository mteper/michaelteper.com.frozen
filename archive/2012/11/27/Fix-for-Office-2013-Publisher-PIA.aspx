...
<script type="text/javascript">
 ...
 var postTitle = "Fix for Office 2013 Publisher PIA";
 var postURL = "http://www.michaelteper.com:443/archive/2012/11/27/Fix-for-Office-2013-Publisher-PIA.aspx";
...
<script type="text/javascript" src="http://www.cocomment.com/js/cocomment.js">
	...
	<body>
		<form name="Form1" method="post" action="Fix-for-Office-2013-Publisher-PIA.aspx" id="Form1">
...
posts - 105, comments - 55, trackbacks - 1</div>
	<div id="switcher">
	    <a id="switchlink" href="Fix-for-Office-2013-Publisher-PIA.aspx#" title="Click here to change the content width" style="display:none;"><span></span></a>
	</div>
</div>
...
<div class="previousNext">
	<a id="ctl06_PreviousNext_PrevLink" title="previous post" href="../../../2009/10/21/httpcontext.current.profile-is-null-in-iis7-vista-windows-7-2008-server.aspx">&lt;&lt; HttpContext.Current.Profile is null in iis7 (Vista, Windows 7, 2008 Server)</a>
...
<div class="entry">
	<h4><a id="ctl06_TitleUrl" title="Title of this entry." href="Fix-for-Office-2013-Publisher-PIA.aspx">Fix for Office 2013 Publisher PIA</a></h4>
	<p>So, Office 2013 is out, and out of the box there is an unpleasant surprise: our code driving Publisher via the interop assembly no longer compiles. After much digging, turns out Microsoft managed to screw up the registry entry for the Publisher PIA.</p>
<p>Here's the fix, step by step:</p>
<ol>
    <li>Fire up regedit (usual caveats apply, don't blame me if your computer blows up)</li>
    <li>Run a search for "<font face="Arial">0002123C-0000-0000-C000-000000000046" (without quotes)</font></li>
    <li>The first hit should be <font face="Arial">HKEY_CLASSES_ROOT\Typelib\{0002123C-0000-0000-C000-000000000046}</font></li>
    <li>Expand the key, observe two subkeys, "2.1" and "2.2" -- you've found the problem!</li>
    <li>Note how the 2.1 key has a "<font face="Arial">PrimaryInteropAssemblyName" string value, and the 2.2 key does not? Well, that value belongs in 2.2 and 2.1 should not be there at all, so let's make it so:</font></li>
    <li>Create a new string value inside the 2.2 key, named "<font face="Arial">PrimaryInteropAssemblyName" with value set to "<font face="Arial">Microsoft.Office.Interop.Publisher, Version=15.0.0.0, Culture=neutral, PublicKeyToken=71E9BCE111E9429C"</font></font></li>
    <li>Delete the 2.1 key</li>
    <li>Voila!</li>
</ol>
<p>Your Visual Studio reference to the Publisher interop assembly should now be happy again.</p>

		<p class="post">
			posted @ Tuesday, November 27, 2012 1:05 AM
		</p>
</div>
   ...
   <rdf:RDF 
      ...
      <rdf:Description
         rdf:about="http://www.michaelteper.com:443/archive/2012/11/27/Fix-for-Office-2013-Publisher-PIA.aspx"
         dc:identifier="http://www.michaelteper.com:443/archive/2012/11/27/Fix-for-Office-2013-Publisher-PIA.aspx"
         dc:title="Fix for Office 2013 Publisher PIA"
         trackback:ping="/services/trackbacks/28518.aspx" 
      />
   </rdf:RDF>
