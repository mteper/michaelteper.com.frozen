...
<script type="text/javascript">
 ...
 var postTitle = "Zenfolio review update";
 var postURL = "http://www.michaelteper.com:443/archive/2009/01/23/zenfolio-review-update.aspx";
...
<script type="text/javascript" src="http://www.cocomment.com/js/cocomment.js">
	...
	<body>
		<form name="Form1" method="post" action="zenfolio-review-update.aspx" id="Form1">
...
posts - 105, comments - 55, trackbacks - 1</div>
	<div id="switcher">
	    <a id="switchlink" href="zenfolio-review-update.aspx#" title="Click here to change the content width" style="display:none;"><span></span></a>
	</div>
</div>
...
<div class="previousNext">
	<a id="ctl06_PreviousNext_PrevLink" title="previous post" href="../../../2008/09/22/c-number-format-expression-for-large-numbers.aspx">&lt;&lt; C# number format expression for large numbers</a>
	...
	<a id="ctl06_PreviousNext_NextLink" title="next post" href="../../03/03/add-client-side-onchange-handler-to-asp.net-checkbox-control.aspx">Add client-side onchange handler to ASP.NET CheckBox control &gt;&gt;</a>
</div>


<div class="entry">
	<h4><a id="ctl06_TitleUrl" title="Title of this entry." href="zenfolio-review-update.aspx">Zenfolio review update</a></h4>
...
<p>Overall, after nearly 3 years of use, I am very happy with the service and will continue using <a href="http://www.zenfolio.com">Zenfolio</a> for the foreseeable future. If you'd like to try <a target="_blank" href="http://www.zenfolio.com">Zenfolio</a>, you can save $5 by using coupon code <strong>EMY-8VU-9MT </strong>(if you sign up, I will get a credit of $5 as well.)</p>
		...
		<p class="post">
			posted @ Friday, January 23, 2009 1:40 AM
		</p>
</div>
   ...
   <rdf:RDF 
      ...
      <rdf:Description
         rdf:about="http://www.michaelteper.com:443/archive/2009/01/23/zenfolio-review-update.aspx"
         dc:identifier="http://www.michaelteper.com:443/archive/2009/01/23/zenfolio-review-update.aspx"
         dc:title="Zenfolio review update"
         trackback:ping="/services/trackbacks/28513.aspx" 
      />
   </rdf:RDF>
