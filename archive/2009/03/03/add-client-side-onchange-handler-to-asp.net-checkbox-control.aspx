...
<script type="text/javascript">
 ...
 var postURL = "http://www.michaelteper.com:443/archive/2009/03/03/add-client-side-onchange-handler-to-asp.net-checkbox-control.aspx";
...
posts - 105, comments - 55, trackbacks - 1</div>
	<div id="switcher">
	    <a id="switchlink" href="add-client-side-onchange-handler-to-asp.net-checkbox-control.aspx#" title="Click here to change the content width" style="display:none;"><span></span></a>
	</div>
</div>
...
<div class="previousNext">
	<a id="ctl06_PreviousNext_PrevLink" title="previous post" href="../../01/23/zenfolio-review-update.aspx">&lt;&lt; Zenfolio review update</a>
	...
	<a id="ctl06_PreviousNext_NextLink" title="next post" href="../../04/16/cure-long-startup-delay-of-vs2008-debugger.aspx">Cure long startup delay of vs2008 debugger &gt;&gt;</a>
</div>


<div class="entry">
	<h4><a id="ctl06_TitleUrl" title="Title of this entry." href="add-client-side-onchange-handler-to-asp.net-checkbox-control.aspx">Add client-side onchange handler to ASP.NET CheckBox control</a></h4>
...
Does it work? <strong>Yes!</strong></p>
   ...
   <rdf:RDF 
      ...
      <rdf:Description
         rdf:about="http://www.michaelteper.com:443/archive/2009/03/03/add-client-side-onchange-handler-to-asp.net-checkbox-control.aspx"
         dc:identifier="http://www.michaelteper.com:443/archive/2009/03/03/add-client-side-onchange-handler-to-asp.net-checkbox-control.aspx"
