...
<script type="text/javascript">
 ...
 var postTitle = "HttpContext.Current.Profile is null in iis7 (Vista, Windows 7, 2008 Server)";
 var postURL = "http://www.michaelteper.com:443/archive/2009/10/21/httpcontext.current.profile-is-null-in-iis7-vista-windows-7-2008-server.aspx";
...
<script type="text/javascript" src="http://www.cocomment.com/js/cocomment.js">
	...
	<body>
		<form name="Form1" method="post" action="httpcontext.current.profile-is-null-in-iis7-vista-windows-7-2008-server.aspx" id="Form1">
...
posts - 105, comments - 55, trackbacks - 1</div>
	<div id="switcher">
	    <a id="switchlink" href="httpcontext.current.profile-is-null-in-iis7-vista-windows-7-2008-server.aspx#" title="Click here to change the content width" style="display:none;"><span></span></a>
	</div>
</div>
...
<div class="previousNext">
	<a id="ctl06_PreviousNext_PrevLink" title="previous post" href="../10/enable-network-drive-support-in-windows-live-movie-maker.aspx">&lt;&lt; Enable network drive support in Windows Live Movie Maker</a>
	...
	<a id="ctl06_PreviousNext_NextLink" title="next post" href="../../../2012/11/27/Fix-for-Office-2013-Publisher-PIA.aspx">Fix for Office 2013 Publisher PIA &gt;&gt;</a>
</div>


<div class="entry">
	<h4><a id="ctl06_TitleUrl" title="Title of this entry." href="httpcontext.current.profile-is-null-in-iis7-vista-windows-7-2008-server.aspx">HttpContext.Current.Profile is null in iis7 (Vista, Windows 7, 2008 Server)</a></h4>
	<p>Took an ASP.NET app to an IIS7 and suddenly lost access to Profile. After much trial, error, and Googling, found that the following attribute must be present on the &lt;modules&gt; element inside the &lt;system.webserver&gt; element:</p>
...
Hope I saved you some time.
   ...
   <rdf:RDF 
      ...
      <rdf:Description
         rdf:about="http://www.michaelteper.com:443/archive/2009/10/21/httpcontext.current.profile-is-null-in-iis7-vista-windows-7-2008-server.aspx"
         dc:identifier="http://www.michaelteper.com:443/archive/2009/10/21/httpcontext.current.profile-is-null-in-iis7-vista-windows-7-2008-server.aspx"
         dc:title="HttpContext.Current.Profile is null in iis7 (Vista, Windows 7, 2008 Server)"
         trackback:ping="/services/trackbacks/28517.aspx" 
      />
   </rdf:RDF>
