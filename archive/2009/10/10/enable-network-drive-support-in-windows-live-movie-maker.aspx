...
<script type="text/javascript">
 ...
 var postTitle = "Enable network drive support in Windows Live Movie Maker";
 var postURL = "http://www.michaelteper.com:443/archive/2009/10/10/enable-network-drive-support-in-windows-live-movie-maker.aspx";
...
<script type="text/javascript" src="http://www.cocomment.com/js/cocomment.js">
	...
	<body>
		<form name="Form1" method="post" action="enable-network-drive-support-in-windows-live-movie-maker.aspx" id="Form1">
...
posts - 105, comments - 55, trackbacks - 1</div>
	<div id="switcher">
	    <a id="switchlink" href="enable-network-drive-support-in-windows-live-movie-maker.aspx#" title="Click here to change the content width" style="display:none;"><span></span></a>
	</div>
</div>
...
<div class="previousNext">
	<a id="ctl06_PreviousNext_PrevLink" title="previous post" href="../../04/16/cure-long-startup-delay-of-vs2008-debugger.aspx">&lt;&lt; Cure long startup delay of vs2008 debugger</a>
	...
	<a id="ctl06_PreviousNext_NextLink" title="next post" href="../21/httpcontext.current.profile-is-null-in-iis7-vista-windows-7-2008-server.aspx">HttpContext.Current.Profile is null in iis7 (Vista, Windows 7, 2008 Server) &gt;&gt;</a>
</div>


<div class="entry">
	<h4><a id="ctl06_TitleUrl" title="Title of this entry." href="enable-network-drive-support-in-windows-live-movie-maker.aspx">Enable network drive support in Windows Live Movie Maker</a></h4>
	<p>Via <a href="http://feedproxy.google.com/~r/seanalexander/FkEB/~3/mvbqEIyi8ak/HowToAddNetworkDriveSupportToWindowsLiveMovieMaker.aspx">here</a> and <a href="http://nysicsclubhouse.wordpress.com/2009/08/20/add-network-videos-and-pictures-to-windows-live-movie-maker">here</a>:</p>
...
<p> </p>
		...
		<p class="post">
			posted @ Saturday, October 10, 2009 11:36 PM
		</p>
</div>
   ...
   <rdf:RDF 
      ...
      <rdf:Description
         rdf:about="http://www.michaelteper.com:443/archive/2009/10/10/enable-network-drive-support-in-windows-live-movie-maker.aspx"
         dc:identifier="http://www.michaelteper.com:443/archive/2009/10/10/enable-network-drive-support-in-windows-live-movie-maker.aspx"
         dc:title="Enable network drive support in Windows Live Movie Maker"
         trackback:ping="/services/trackbacks/28516.aspx" 
      />
   </rdf:RDF>
