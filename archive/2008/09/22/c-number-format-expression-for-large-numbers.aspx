...
<script type="text/javascript">
 ...
 var postTitle = "C# number format expression for large numbers";
 var postURL = "http://www.michaelteper.com:443/archive/2008/09/22/c-number-format-expression-for-large-numbers.aspx";
...
<script type="text/javascript" src="http://www.cocomment.com/js/cocomment.js">
	...
	<body>
		<form name="Form1" method="post" action="c-number-format-expression-for-large-numbers.aspx" id="Form1">
...
posts - 105, comments - 55, trackbacks - 1</div>
	<div id="switcher">
	    <a id="switchlink" href="c-number-format-expression-for-large-numbers.aspx#" title="Click here to change the content width" style="display:none;"><span></span></a>
	</div>
</div>
...
<div class="previousNext">
	<a id="ctl06_PreviousNext_PrevLink" title="previous post" href="../../07/01/another-problem-with-mozy-restore.aspx">&lt;&lt; Another problem with Mozy restore</a>
	...
	<a id="ctl06_PreviousNext_NextLink" title="next post" href="../../../2009/01/23/zenfolio-review-update.aspx">Zenfolio review update &gt;&gt;</a>
</div>


<div class="entry">
	<h4><a id="ctl06_TitleUrl" title="Title of this entry." href="c-number-format-expression-for-large-numbers.aspx">C# number format expression for large numbers</a></h4>
	<p>This expression will format large number with a thousands separator:</p>
...
<p class="MsoNormal" style="MARGIN: 0in 0in 0pt"><span style="FONT-SIZE: 10pt; FONT-FAMILY: &quot;Courier New&quot;">.ToString(<span style="COLOR: #a31515">"#,#"</span>)<o:p /></span></p>
   ...
   <rdf:RDF 
      ...
      <rdf:Description
         rdf:about="http://www.michaelteper.com:443/archive/2008/09/22/c-number-format-expression-for-large-numbers.aspx"
         dc:identifier="http://www.michaelteper.com:443/archive/2008/09/22/c-number-format-expression-for-large-numbers.aspx"
         dc:title="C# number format expression for large numbers"
         trackback:ping="/services/trackbacks/28512.aspx" 
      />
   </rdf:RDF>
