...
<script type="text/javascript">
 ...
 var postTitle = "An error occurred while using the BCP utility";
 var postURL = "http://www.michaelteper.com:443/archive/2008/05/13/an-error-occurred-while-using-the-bcp-utility.aspx";
...
<script type="text/javascript" src="http://www.cocomment.com/js/cocomment.js">
	...
	<body>
		<form name="Form1" method="post" action="an-error-occurred-while-using-the-bcp-utility.aspx" id="Form1">
...
posts - 105, comments - 55, trackbacks - 1</div>
	<div id="switcher">
	    <a id="switchlink" href="an-error-occurred-while-using-the-bcp-utility.aspx#" title="Click here to change the content width" style="display:none;"><span></span></a>
	</div>
</div>
...
<div class="previousNext">
	<a id="ctl06_PreviousNext_PrevLink" title="previous post" href="../../../2007/12/06/a-recent-lolcat-favorite.aspx">&lt;&lt; Recent lolcat favorites</a>
	...
	<a id="ctl06_PreviousNext_NextLink" title="next post" href="../../06/27/mozy-review-the-restore-horror-story.aspx">Mozy review: the restore horror story &gt;&gt;</a>
</div>


<div class="entry">
	<h4><a id="ctl06_TitleUrl" title="Title of this entry." href="an-error-occurred-while-using-the-bcp-utility.aspx">An error occurred while using the BCP utility</a></h4>
	<p>If you are installing Microsoft Dynamics GP on Windows Vista, you may run into this error after starting GP Utilities:</p>
...
<p>It took quite a while, but I finally got this resolved. The solution is simple: run GP Utilities as Administrator.</p>

		<p class="post">
			posted @ Tuesday, May 13, 2008 2:02 PM
		</p>
</div>
   ...
   <rdf:RDF 
      ...
      <rdf:Description
         rdf:about="http://www.michaelteper.com:443/archive/2008/05/13/an-error-occurred-while-using-the-bcp-utility.aspx"
         dc:identifier="http://www.michaelteper.com:443/archive/2008/05/13/an-error-occurred-while-using-the-bcp-utility.aspx"
         dc:title="An error occurred while using the BCP utility"
         trackback:ping="/services/trackbacks/28509.aspx" 
      />
   </rdf:RDF>
